...
namespace HSNXT.Test
{
    ...
    public class TraverseTest
    {
        ...
        {
            Extensions.TraverseDepthFirst(new object(), o => new BreakingSequence<object>());
        }

        [Test]
        public void TraverseBreadthFirstIsStreaming()
        {
            Extensions.TraverseBreadthFirst(new object(), o => new BreakingSequence<object>());
        }

        [Test]
        public void TraverseDepthFirstPreservesChildrenOrder()
        {
            var res = Extensions.TraverseDepthFirst(0, i => i == 0 ? Enumerable.Range(1, 10) : Enumerable.Empty<int>());
        ...
        public void TraverseBreadthFirstTraversesBreadthFirst()
        {
            ...
            var res = Extensions.TraverseBreadthFirst(tree, t => t.Children).Select(t => t.Value);
        ...
        public void TraverseDepthFirstTraversesDepthFirst()
        {
            ...
            var res = Extensions.TraverseDepthFirst(tree, t => t.Children).Select(t => t.Value);
