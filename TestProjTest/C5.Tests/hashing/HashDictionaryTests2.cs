...
namespace HSNXT.C5.Tests.hashing
{
    [TestFixture]
    public class HashDictionaryTests2
    {
        ...
        {
            var dictionary =
                new HashDictionary<string, int>(memoryType) {{"One", 1}, {"Two", 2}, {"Three", 3}, {"Four", 4}};
        ...
        {
            var dictionary =
                new HashDictionary<int, string>(memoryType) {{1, "One"}, {2, "Two"}, {3, "Three"}, {4, "Four"}};
