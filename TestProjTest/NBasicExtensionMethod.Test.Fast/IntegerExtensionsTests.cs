...
namespace HSNXT.Test.Fast
{
    ...
    public class IntegerExtensionsTests
    {
        ...
        [TestCase(45)]
        [TestCase(-45)]
        public void Milliseconds_Should_Return_Timespan_Object_With_Same_Number_Of_Milliseconds_Set_As_Passsed_In(
            int iValue)
        {
            // Arrange
        ...
        public void Years_Should_Return_TimeSpan_Object_With_TotalDays_Set_As_Expected(int iValue,
            double iExpectedReturnValue)
        {
            // Arrange
        ...
        public void IsBetween_Should_Return_True_When_Value_Is_Between_Lower_And_Upper_Boundaries(int iInputValue,
            int iLowerBoundary, int iUpperBoundary)
        {
            // Arrange
        ...
        [TestCase(1, 1, 3)]
        [TestCase(3, 1, 3)]
        public void IsBetween_Should_Return_False_When_Value_Is_Equal_To_Lower_Or_Upper_Boundary(int iInputValue,
            int iLowerBoundary, int iUpperBoundary)
        {
            // Arrange
        ...
        [TestCase(-1, 1, 3)]
        [TestCase(4, 1, 3)]
        public void IsBetween_Should_Return_False_When_Value_Is_Less_Or_Grater_Than_Lower_Or_Upper_Boundary(
            int iInputValue, int iLowerBoundary, int iUpperBoundary)
        {
            // Arrange
        ...
        [TestCase(20, 1, 30)]
        [TestCase(3425, 3000, 30000)]
        public void IsBetweenInclusive_Should_Return_True_When_Value_Is_Between_Lower_And_Upper_Boundaries(
            int iInputValue, int iLowerBoundary, int iUpperBoundary)
        {
            // Arrange
        ...
        [TestCase(1, 1, 3)]
        [TestCase(3, 1, 3)]
        public void IsBetweenInclusive_Should_Return_True_When_Value_Is_Equal_To_Lower_Or_Upper_Boundary(
            int iInputValue, int iLowerBoundary, int iUpperBoundary)
        {
            // Arrange
        ...
        [TestCase(-1, 1, 3)]
        [TestCase(4, 1, 3)]
        public void IsBetweenInclusive_Should_Return_False_When_Value_Is_Less_Or_Grater_Than_Lower_Or_Upper_Boundary(
            int iInputValue,
            int iLowerBoundary,
            int iUpperBoundary)
        {
