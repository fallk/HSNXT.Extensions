...
namespace HSNXT.ComLib.Lang.Tests.Common
{
    ...
    public class CommonTestCases_Plugins
    {
        ...
        protected new static Tuple<string, string, string> Error(string errorType, string errorMsg, string script)
        {
        ...
        public static TestCases AliasInScript = new TestCases()
        {
            ...
            Positive = new List<Tuple<string, Type, object, string>>()
            {
                ...
                TestCase("result", typeof(double), 1,
                    "alias set to var; set result = 0; function test()     {  return 1;         } result = test();"),
                TestCase("result", typeof(double), 2,
                    "alias set to var; set result = 1; function test(a)    { return a + 1;      } result = test(1);"),
                TestCase("result", typeof(double), 4,
                    "alias set to var; set result = 2; function test(a)    { return a + result; } result = test(2);"),
                TestCase("result", typeof(bool), true,
                    "alias set to var; set result = 1; function test(a)    { return true;       } result = test(1);"),
                TestCase("result", typeof(bool), false,
                    "alias set to var; set result = 1; function test(a)    { return false;      } result = test(1);"),
                TestCase("result", typeof(double), 5,
                    "alias set to var; set result = 1; function test(a, b) { return a + b;      } result = test(2,3);"),
                TestCase("result", typeof(double), 3,
                    "alias set to var; set result = 1; function test(a, b) { return a - b;      } result = test(4,1);"),
                TestCase("result", typeof(string), "com",
                    "alias set to var; set result = 1; function test()     { return 'com';      } result = test();"),
                TestCase("result", typeof(double), 1,
                    "alias def to function; var result = 0; def test()     {  return 1;         } result = test();"),
                TestCase("result", typeof(double), 2,
                    "alias def to function; var result = 1; def test(a)    { return a + 1;      } result = test(1);"),
                TestCase("result", typeof(double), 4,
                    "alias def to function; var result = 2; def test(a)    { return a + result; } result = test(2);"),
                TestCase("result", typeof(bool), true,
                    "alias def to function; var result = 1; def test(a)    { return true;       } result = test(1);"),
                TestCase("result", typeof(bool), false,
                    "alias def to function; var result = 1; def test(a)    { return false;      } result = test(1);"),
                TestCase("result", typeof(double), 5,
                    "alias def to function; var result = 1; def test(a, b) { return a + b;      } result = test(2,3);"),
                TestCase("result", typeof(double), 3,
                    "alias def to function; var result = 1; def test(a, b) { return a - b;      } result = test(4,1);"),
                TestCase("result", typeof(string), "com",
                    "alias def to function; var result = 1; def test()     { return 'com';      } result = test();"),
            }
        };
        ...
        public static TestCases Date = new TestCases()
        {
            ...
            Positive = new List<Tuple<string, Type, object, string>>()
            {
                TestCase("i", typeof(double), 1,
                    "var i = 0; var date = oct 2;              if (date.getFullYear() == " + Date_YearNow +
                    " && date.getMonth() == 10 && date.getDate() == 2) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var date = oct 2nd;            if (date.getFullYear() == " + Date_YearNow +
                    " && date.getMonth() == 10 && date.getDate() == 2) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var date = october 2;          if (date.getFullYear() == " + Date_YearNow +
                    " && date.getMonth() == 10 && date.getDate() == 2) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var date = october 2nd;        if (date.getFullYear() == " + Date_YearNow +
                    " && date.getMonth() == 10 && date.getDate() == 2) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var date = oct 2 2011;         if (date.getFullYear() == 2011 && date.getMonth() == 10 && date.getDate() == 2) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var date = oct 2nd 2011;       if (date.getFullYear() == 2011 && date.getMonth() == 10 && date.getDate() == 2) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var date = oct 2, 2011;        if (date.getFullYear() == 2011 && date.getMonth() == 10 && date.getDate() == 2) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var date = oct 2nd, 2011;      if (date.getFullYear() == 2011 && date.getMonth() == 10 && date.getDate() == 2) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var date = october 2 2011;     if (date.getFullYear() == 2011 && date.getMonth() == 10 && date.getDate() == 2) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var date = october 2nd 2011;   if (date.getFullYear() == 2011 && date.getMonth() == 10 && date.getDate() == 2) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var date = october 2, 2011;    if (date.getFullYear() == 2011 && date.getMonth() == 10 && date.getDate() == 2) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var date = october 2nd, 2011;  if (date.getFullYear() == 2011 && date.getMonth() == 10 && date.getDate() == 2) i = 1;")
        ...
        public static TestCases DateNumber = new TestCases()
        {
            ...
            Positive = new List<Tuple<string, Type, object, string>>()
            {
                ...
                TestCase("i", typeof(double), 1,
                    "var i = 0; var date = 10/2/2011;    if (date.getFullYear() == 2011 && date.getMonth() == 10 && date.getDate() == 2) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var date = 10\\2\\2011;  if (date.getFullYear() == 2011 && date.getMonth() == 10 && date.getDate() == 2) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var date = 10-2-2011;    if (date.getFullYear() == 2011 && date.getMonth() == 10 && date.getDate() == 2) i = 1;")
        ...
        public static TestCases Def = new TestCases()
        {
            ...
            {
                TestCase("result", typeof(double), 1,
                    "var result = 0; def test()     {  return 1;         } result = test();"),
                TestCase("result", typeof(double), 2,
                    "var result = 1; def test(a)    { return a + 1;      } result = test(1);"),
                TestCase("result", typeof(double), 4,
                    "var result = 2; def test(a)    { return a + result; } result = test(2);"),
                TestCase("result", typeof(bool), true,
                    "var result = 1; def test(a)    { return true;       } result = test(1);"),
                TestCase("result", typeof(bool), false,
                    "var result = 1; def test(a)    { return false;      } result = test(1);"),
                TestCase("result", typeof(double), 5,
                    "var result = 1; def test(a, b) { return a + b;      } result = test(2,3);"),
                TestCase("result", typeof(double), 3,
                    "var result = 1; def test(a, b) { return a - b;      } result = test(4,1);"),
                TestCase("result", typeof(string), "com",
                    "var result = 1; def test()     { return 'com';      } result = test();")
            }
        };
        ...
        public static TestCases FileExt = new TestCases()
        {
            ...
            Positive = new List<Tuple<string, Type, object, string>>()
            {
                ...
                TestCase("result", typeof(string), "*.svn", "function getSvn() { return *.svn; } result = getSvn();"),
                TestCase("result", typeof(string), "*.svn",
                    "var items = {a: .xml, b:.doc, c:*.svn }; result = items.c;"),
                TestCase("result", typeof(string), "*.svn", "var items = [ .xml, .doc, *.svn ]; result = items[2];"),
        ...
        public static TestCases IO = new TestCases()
        {
            ...
            Positive = new List<Tuple<string, Type, object, string>>()
            {
                ...
                TestCase(null, typeof(object), null,
                    @"copy   file 'c:\\temp\\fs-io-test.txt',  'c:\\temp\\fs-io-test1.txt', true"),
                TestCase(null, typeof(object), null,
                    @"rename file 'c:\\temp\\fs-io-test1.txt',  'fs-io-test2.txt', true"),
                TestCase(null, typeof(object), null, @"delete file 'c:\\temp\\fs-io-test.txt' "),
                TestCase(null, typeof(object), null,
                    @"move   file 'c:\\temp\\fs-io-test2.txt',  'c:\\temp\\fs-io-test.txt'"),
                TestCase(null, typeof(object), null, @"delete file 'c:\\temp\\fs-io-test.txt' "),
                ...
                TestCase(null, typeof(object), null,
                    @"File.Copy  ( 'c:\\temp\\fs-io-test.txt',  'c:\\temp\\fs-io-test1.txt', true );"),
                TestCase(null, typeof(object), null,
                    @"File.Rename( 'c:\\temp\\fs-io-test1.txt',  'fs-io-test2.txt', true );"),
                TestCase(null, typeof(object), null, @"File.Delete( 'c:\\temp\\fs-io-test.txt' );"),
                TestCase(null, typeof(object), null,
                    @"File.Move  ( 'c:\\temp\\fs-io-test2.txt',  'c:\\temp\\fs-io-test.txt'  );"),
                TestCase(null, typeof(object), null, @"File.Delete( 'c:\\temp\\fs-io-test.txt' );"),
        ...
        public static TestCases Money = new TestCases()
        {
            ...
            Positive = new List<Tuple<string, Type, object, string>>()
            {
                ...
                TestCase("a", typeof(double), 24.50,
                    "var a = 0; var salary = $24.50; if salary > $16.85 then a = $24.50;"),
            }
        };
        ...
        public static TestCases Repeat = new TestCases()
        {
            ...
            Positive = new List<Tuple<string, Type, object, string>>()
            {
                TestCase("result", typeof(double), 26,
                    "result = 0; var a = 18;                   var b = 30; var c = 4; repeat ndx = a to < b by c { result = ndx; }"),
                TestCase("result", typeof(double), 26,
                    "result = 0; var a = [10, 18];             var b = 30; var c = 4; repeat ndx = a[1] to < b by c { result = ndx; }"),
                TestCase("result", typeof(double), 26,
                    "result = 0; var a = { one: 10, two: 18};  var b = 30; var c = 4; repeat ndx = a.two to < b by c { result = ndx; }"),
                TestCase("result", typeof(double), 26,
                    "result = 0; function getA(){ return 18; } var b = 30; var c = 4; repeat ndx = getA() to < b by c { result = ndx; }"),
        ...
        public static TestCases Run = new TestCases()
        {
            ...
            {
                TestCase("result", typeof(double), 2,
                    "var result = 1; function 'add 1'    { result = result + 1; } run 'add 1'; "),
                TestCase("result", typeof(double), 2,
                    "var result = 1; function  add1      { result = result + 1; } run  add1; "),
                TestCase("result", typeof(double), 2,
                    "var result = 1; function 'add 1'    { result = result + 1; } run 'add 1'(); "),
                TestCase("result", typeof(double), 3,
                    "var result = 1; function 'add 2'    { result = result + 2; } run function 'add 2'(); "),
                TestCase("result", typeof(double), 4,
                    "var result = 1; function 'add 3'    { return result + 3; } result = run 'add 3'(); "),
                TestCase("result", typeof(double), 5,
                    "var result = 1; function 'add 4'    { return result + 4; } result = run function 'add 4'(); "),

                TestCase("result", typeof(double), 4,
                    "var result = 0; function 'add 3'(a) { return a + 3;   } result = run 'add 3'(1); "),
                TestCase("result", typeof(double), 4,
                    "var result = 0; function 'add 3'(a) { return a + 3;   } result = run function 'add 3'(1); "),
                TestCase("result", typeof(double), 2,
                    "var result = 0; function 'add 1'(a) { result = a + 1; } run 'add 1'(1); "),
                TestCase("result", typeof(double), 4,
                    "var result = 0; function 'add 3'(a) { result = a + 3; } run function 'add 3'(1); ")
            }
        };
        ...
        public static TestCases Set = new TestCases()
        {
            ...
            {
                TestCase("result", typeof(double), 1,
                    "set result = 0; function test()     {  return 1;         } result = test();"),
                TestCase("result", typeof(double), 2,
                    "set result = 1; function test(a)    { return a + 1;      } result = test(1);"),
                TestCase("result", typeof(double), 4,
                    "set result = 2; function test(a)    { return a + result; } result = test(2);"),
                TestCase("result", typeof(bool), true,
                    "set result = 1; function test(a)    { return true;       } result = test(1);"),
                TestCase("result", typeof(bool), false,
                    "set result = 1; function test(a)    { return false;      } result = test(1);"),
                TestCase("result", typeof(double), 5,
                    "set result = 1; function test(a, b) { return a + b;      } result = test(2,3);"),
                TestCase("result", typeof(double), 3,
                    "set result = 1; function test(a, b) { return a - b;      } result = test(4,1);"),
                TestCase("result", typeof(string), "com",
                    "set result = 1; function test()     { return 'com';      } result = test();")
            }
        };
        ...
        /// Test cases for the typeof plugin
        /// </summary>
        private static string Sort_books =
            "[	name	|	isactive	| pubdate	          |	pubtime	            |	totalpages  \r\n"
        ...
        public static TestCases Sort = new TestCases()
        {
            ...
            Positive = new List<Tuple<string, Type, object, string>>()
            {
                TestCase("result", typeof(string), "book 1",
                    Sort_books_var + "; sort books by book.name asc      ; result = books[0].name"),
                TestCase("result", typeof(bool), false,
                    Sort_books_var + "; sort books by book.isactive asc  ; result = books[0].isactive"),
                TestCase("result", typeof(double), 110,
                    Sort_books_var + "; sort books by book.totalpages asc; result = books[0].totalpages"),
                TestCase("result", typeof(DateTime), Sort_dt,
                    Sort_books_var + "; sort books by book.pubdate asc   ; result = books[0].pubdate"),
                TestCase("result", typeof(TimeSpan), Sort_ts,
                    Sort_books_var + "; sort books by book.pubtime asc   ; result = books[0].pubtime"),
        ...
        public static TestCases StringLiteral = new TestCases()
        {
            ...
            Positive = new List<Tuple<string, Type, object, string>>()
            {
                ...
                TestCase("result", typeof(string), "user02",
                    "var items = [ :user01, :user02 ];         var result = items[1]"),
                TestCase("result", typeof(string), "user02",
                    "var items = { u1: :user01, u2: :user02 }; var result = items.u2"),
                TestCase("result", typeof(string), 1, "var result = 0;  if ( :user01 == 'user01' ) result = 1"),
                TestCase("result", typeof(string), "user_name doe",
                    "function abc( text ) { return text + ' doe'; } var result = abc( :user_name )")
            }
        };
        ...
        public static TestCases TypeOf = new TestCases()
        {
            ...
            Positive = new List<Tuple<string, Type, object, string>>()
            {
                ...
                TestCase("result", typeof(string), "function:inc",
                    "function inc(a){ return a + 1; } result = typeof inc"),
                TestCase("result", typeof(string), "object:ComLib.Lang.Tests.Common.User",
                    "var user = new User('john'); result = typeof user"),
                ...
                TestCase("result", typeof(string), "datetime",
                    "var item = new Date(2012, 8, 10)	; var result = typeof item"),
                TestCase("result", typeof(string), "time",
                    "var item = new Time(8, 30, 10)		; var result = typeof item"),
                TestCase("result", typeof(string), "object:list", "var item = [0, 1, 2]				; var result = typeof item"),
                TestCase("result", typeof(string), "object:map",
                    "var item = { one: 1, two: 2 }		; var result = typeof item"),
            }
        };
        ...
        public static TestCases TimeExpr = new TestCases()
        {
            ...
            {
                TestCase("i", typeof(double), 1,
                    "var i = 0; var time = 730 am;      if (time.Hours == 7  && time.Minutes == 30  && time.Seconds == 0 ) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var time = 1030 am;     if (time.Hours == 10 && time.Minutes == 30  && time.Seconds == 0 ) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var time = 1030pm;      if (time.Hours == 22 && time.Minutes == 30  && time.Seconds == 0 ) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var time = 12pm;        if (time.Hours == 12 && time.Minutes == 0   && time.Seconds == 0 ) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var time = 9:30 am;     if (time.Hours == 9  && time.Minutes == 30  && time.Seconds == 0 ) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var time = 10:45:20 pm; if (time.Hours == 22 && time.Minutes == 45  && time.Seconds == 20) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var time = 09:45:32 pm; if (time.Hours == 21 && time.Minutes == 45  && time.Seconds == 32) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var time = noon;        if (time.Hours == 12 && time.Minutes == 0   && time.Seconds == 0 ) i = 1;"),
                TestCase("i", typeof(double), 1,
                    "var i = 0; var time1 = 9am; var time2 = 11am;  if (time1 < time2 ) i = 1;"),
        ...
        public static TestCases Uri = new TestCases()
        {
            ...
            Positive = new List<Tuple<string, Type, object, string>>()
            {
                ...
                TestCase("result", typeof(string), "http://www.yahoo.com?user=kishore%20&id=123",
                    "var result = http://www.yahoo.com?user=kishore%20&id=123 ;"),

                TestCase("result", typeof(string), "www.yahoo1.com",
                    "var items = ['abc', www.yahoo1.com];        var result = items[1];"),
                TestCase("result", typeof(string), "www.yahoo2.com",
                    "var items = ['abc', www.yahoo2.com, 'def']; var result = items[1];"),
                TestCase("result", typeof(string), "www.yahoo3.com",
                    "var items = { name: www.yahoo3.com };       var result = items.name; "),
                TestCase("result", typeof(string), "www.yahoo4.com",
                    "function abc(name) { return name; }         var result = abc(www.yahoo4.com);"),
        ...
        public static TestCases VarPath = new TestCases()
        {
            ...
            Positive = new List<Tuple<string, Type, object, string>>()
            {
                TestCase("result", typeof(string), "c:\\myapp\\version\\build\\fs.xml",
                    "var script = 'fs'; version = '2.0'; var home = 'c:\\\\myapp'; var result = @home\\version\\build\\@script.xml"),
                TestCase("result", typeof(string), "c:\\myapp\\version\\build\\fs-build.xml",
                    "var script = 'fs'; version = '2.0'; var home = 'c:\\\\myapp'; var result = @home\\version\\build\\@script-build.xml"),
                TestCase("result", typeof(string), "c:\\myapp\\version\\build\\fs.build.xml",
                    "var script = 'fs'; version = '2.0'; var home = 'c:\\\\myapp'; var result = @home\\version\\build\\@script.build.xml"),
                TestCase("result", typeof(string), "c:\\myapp\\version\\build\\fsbuild.xml",
                    "var script = 'fs'; version = '2.0'; var home = 'c:\\\\myapp'; var result = @home\\version\\build\\@{script}build.xml"),
                TestCase("result", typeof(string), "c:\\myapp\\version\\build\\fs-build.xml",
                    "var script = 'fs'; version = '2.0'; var home = 'c:\\\\myapp'; var result = @home\\version\\build\\@{script}-build.xml"),
                TestCase("result", typeof(string), "c:\\myapp\\version\\build\\fs.build.xml",
                ...
                TestCase("result", typeof(string), "c:\\myapp\\2.0\\build\\fsbuild.xml",
                    "var script = 'fs'; version = '2.0'; var home = 'c:\\\\myapp'; var result = @home\\@version\\build\\@{script}build.xml"),
                TestCase("result", typeof(string), "c:\\myapp\\2.0-version\\build\\fs-build.xml",
                    "var script = 'fs'; version = '2.0'; var home = 'c:\\\\myapp'; var result = @home\\@version-version\\build\\@{script}-build.xml"),
                TestCase("result", typeof(string), "c:\\myapp\\2.0.version\\build\\fs.build.xml",
                    "var script = 'fs'; version = '2.0'; var home = 'c:\\\\myapp'; var result = @home\\@version.version\\build\\@{script}.build.xml"),
                TestCase("result", typeof(string), "c:\\myapp\\version-2.0\\build\\fs-build.xml",
                    "var script = 'fs'; version = '2.0'; var home = 'c:\\\\myapp'; var result = @home\\version-@version\\build\\@{script}-build.xml"),
                TestCase("result", typeof(string), "c:\\myapp\\version.2.0\\build\\fs.build.xml",
                    "var script = 'fs'; version = '2.0'; var home = 'c:\\\\myapp'; var result = @home\\version.@version\\build\\@{script}.build.xml"),
                TestCase("result", typeof(string), "c:\\myapp\\version2.0\\build\\fs.build.xml",
                    "var script = 'fs'; version = '2.0'; var home = 'c:\\\\myapp'; var result = @home\\version@version\\build\\@{script}.build.xml"),
                TestCase("result", typeof(string), "c:\\myapp\\2.0-version\\build\\fs-build.xml",
                    "var script = 'fs'; version = '2.0'; var home = 'c:\\\\myapp'; var result = @home\\@{version}-version\\build\\@{script}-build.xml"),
                TestCase("result", typeof(string), "c:\\myapp\\2.0.version\\build\\fs.build.xml",
                    "var script = 'fs'; version = '2.0'; var home = 'c:\\\\myapp'; var result = @home\\@{version}.version\\build\\@{script}.build.xml"),
                TestCase("result", typeof(string), "c:\\myapp\\2.0version\\build\\fs.build.xml",
                    "var script = 'fs'; version = '2.0'; var home = 'c:\\\\myapp'; var result = @home\\@{version}version\\build\\@{script}.build.xml"),

                TestCase("result", typeof(string), "c:\\myapp\\build\\script.xml",
                    "var home = 'c:\\\\myapp'; var result = home\\build\\script.xml"),
                TestCase("result", typeof(string), "c:\\myapp\\app-build\\script.xml",
                    "var home = 'c:\\\\myapp'; var result = home\\app-build\\script.xml"),
                TestCase("result", typeof(string), "c:\\myapp\\app_build\\script.xml",
                    "var home = 'c:\\\\myapp'; var result = home\\app_build\\script.xml"),
                TestCase("result", typeof(string), "c:\\myapp\\app-build12\\script.xml",
                    "var home = 'c:\\\\myapp'; var result = home\\app-build12\\script.xml"),
                TestCase("result", typeof(string), "c:\\myapp\\version_1.2.3\\script.xml",
                    "var home = 'c:\\\\myapp'; var result = home\\version_1.2.3\\script.xml"),
                TestCase("result", typeof(string), "c:\\myapp\\version_1.2.3\\script.xml",
                    "var home = 'c:\\\\myapp'; var result = @home\\version_1.2.3\\script.xml"),
            }
        };
        ...
        public static TestCases Version = new TestCases()
        {
            ...
            Positive = new List<Tuple<string, Type, object, string>>()
            {
                ...
                TestCase("result", typeof(string), "3.5.702.18",
                    "var version = 3.5.702.18; result = version.Text()\r\n"),
                TestCase("result", typeof(string), "3.5.702.18", "var version = 3.5.702.18; result = version.Text()"),
                ...
                TestCase("result", typeof(string), "1.5.2.80",
                    "function getVersion() { return 1.5.2.80; } result = getVersion().Text();"),
                TestCase("result", typeof(string), "1.5.2.80",
                    "var items = {a: 1.2, b: 2, c: 1.5.2.80 }; result = items.c.Text();"),
                TestCase("result", typeof(string), "1.5.2.80",
                    "var items = [ 1.2, 1.3, 1.5.2.80 ]; result = items[2].Text();"),
        ...
        private static string Records_Extra =
            "var num = 20; var name = 'catcher'; var active = true; function add(a, b) { return a + b; }";

        private static string Records_List1 = Records_Extra +
                                              " var books = [ name | pages | isactive \r\n name + ' rye' | num + 100 | true \r\n 'book 1' | add( num, 110) | active \r\n 'book 1' | ( 20 * 5 ) + add(20, num) | !active \r\n ];";
