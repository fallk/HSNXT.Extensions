...
namespace HSNXT.ComLib.Lang.Tests.Integration.System
{
    ...
    public class Types_Strings : ScriptTestsBase
    {
        ...
        public void Can_Read_Interpolated_Strings()
        {
            var statements = new List<Tuple<string, Type, object, string>>()
            {
                TestCase("fullname", typeof(string), "3 plus reddy",
                    "var first = 'kishore'; var last = 'reddy'; var fullname = \"#{1 + 2} plus #{last}\";"),
                TestCase("fullname", typeof(string), "kishore plus reddy",
                    "var first = 'kishore'; var last = 'reddy'; var fullname = \"#{first} plus #{last}\";"),
                TestCase("fullname", typeof(string), "before kishore plus reddy after",
                    "var first = 'kishore'; var last = 'reddy'; var fullname = \"before #{first} plus #{last} after\";"),
                TestCase("fullname", typeof(string), "kishore plus reddy",
                    "var first = 'kishore'; var last = 'reddy'; var fullname = \"#{first} plus #{last}\";"),
                TestCase("fullname", typeof(string), "kishore mid:kdog reddy",
                    "var user = { name: 'kishore', middle: 'kdog' }; var last = 'reddy'; var fullname = \"#{user.name} mid:#{user.middle} #{last}\";"),
                TestCase("result", typeof(string), "exp 7, func 3",
                    "function add( a, b ) return a + b; var num = 2; var result = \"exp #{5 + num}, func #{add( num, 1)}\""),
            };
            Parse(statements);
        }
        ...
        public void Can_Do_String_Method_Calls()
        {
            var statements = new List<Tuple<string, Type, object, string>>()
            {
                TestCase("result", typeof(string), "common@lib",
                    "var name = 'COmmOn@Lib'; var result = name.toLowerCase();"),
                TestCase("result", typeof(string), "COMMON@LIB",
                    "var name = 'COmmOn@Lib'; var result = name.toUpperCase();"),
                ...
                TestCase("result", typeof(string), "mmO",
                    "var name = 'COmmOn@Lib'; var result = name.substring(2, 4);"),
                TestCase("result", typeof(string), "COnnOn@Lib",
                    "var name = 'COmmOn@Lib'; var result = name.replace('mm', 'nn');")
            };
            Parse(statements);
        }
    }
    ...
    public class Types_Dictionary : ScriptTestsBase
    {
        ...
        public void Can_Declare()
        {
            ...
            var statements = new List<Tuple<string, Type, object, string>>()
            {
                TestCase("result", typeof(string), "kishore",
                    "var data = { name: 'kishore', id: 123, isactive: true, dt: new Date(), salary: 80.5 }; var result = data.name;"),
                TestCase("result", typeof(double), 123,
                    "var data = { name: 'kishore', id: 123, isactive: true, dt: new Date(), salary: 80.5 }; var result = data.id;"),
                TestCase("result", typeof(bool), true,
                    "var data = { name: 'kishore', id: 123, isactive: true, dt: new Date(), salary: 80.5 }; var result = data.isactive;"),
                TestCase("result", typeof(bool), date,
                    "var data = { name: 'kishore', id: 123, isactive: true, dt: new Date(2012, 8, 1), salary: 80.5 }; var result = data.dt;"),
            };
            Parse(statements);
        }
        ...
        {
            var maptxt =
                @"{ FirstName: 'john', LastName: 'doe', Email: 'johndoe@email.com', IsMale: true, Salary: 10.5, BirthDate: new Date(), Address: { City: 'Queens', State: 'NY' } }";
            var testcases = new List<Tuple<string, Type, object, string>>()
            {
                ...
                TestCase("result", typeof(string), "johndoe@email.com",
                    "var p = " + maptxt + "; var result = p.Email;"),
                TestCase("result", typeof(bool), true, "var p = " + maptxt + "; var result = p.IsMale;"),
                TestCase("result", typeof(DateTime), DateTime.Today,
                    "var p = " + maptxt + "; var result = p.BirthDate;"),
        ...
        public void Can_Set_Nested_Member_Property()
        {
            ...
            var testcases = new List<Tuple<string, Type, object, string>>()
            {
                TestCase("result", typeof(string), "jane",
                    "var p = " + maptxt + ";  p.FirstName = 'jane';     var result = p.FirstName;"),
                TestCase("result", typeof(string), "janedoe@email.com",
                    "var p = " + maptxt + ";  p.Email     = 'janedoe@email.com'; var result = p.Email;"),
                TestCase("result", typeof(bool), false,
                    "var p = " + maptxt + ";  p.IsMale    =  false;       var result = p.IsMale;"),
                TestCase("result", typeof(DateTime), DateTime.Today,
                    "var p = " + maptxt + ";  p.BirthDate = new Date();   var result = p.BirthDate;"),
                TestCase("result", typeof(string), "Bronx",
                    "var p = " + maptxt + ";  p.Address.City = 'Bronx';   var result = p.Address.City;"),
                TestCase("result", typeof(string), "NJ",
                    "var p = " + maptxt + ";  p.Address.State = 'NJ';     var result = p.Address.State;")
            };
            RunTestCases(testcases);
        }
    }
    ...
    public class Types_Dates : ScriptTestsBase
    {
        ...
        public void Can_Subtract_Dates()
        {
            var statements = new List<Tuple<string, Type, object, string>>()
            {
                TestCase("result", typeof(double), 0,
                    "var result = 0; var date1 = new Date(2012, 1, 8, 10, 30, 30); var date2 = new Date(2012, 1, 9, 8, 15, 40); var diff = date2 - date1; result = diff.Days;"),
                TestCase("result", typeof(double), 21,
                    "var result = 0; var date1 = new Date(2012, 1, 8, 10, 30, 30); var date2 = new Date(2012, 1, 9, 8, 15, 40); var diff = date2 - date1; result = diff.Hours;"),
                TestCase("result", typeof(double), 45,
                    "var result = 0; var date1 = new Date(2012, 1, 8, 10, 30, 30); var date2 = new Date(2012, 1, 9, 8, 15, 40); var diff = date2 - date1; result = diff.Minutes;"),
                TestCase("result", typeof(double), 10,
                    "var result = 0; var date1 = new Date(2012, 1, 8, 10, 30, 30); var date2 = new Date(2012, 1, 9, 8, 15, 40); var diff = date2 - date1; result = diff.Seconds;")
            };
            Parse(statements);
        }
        ...
        public void Can_Do_Date_Method_Calls()
        {
            ...
            var testcases = new List<Tuple<string, Type, object, string>>()
            {
                ...
                TestCase("result", typeof(int), (int) date.ToUniversalTime().DayOfWeek,
    ...
    public class Types_Time : ScriptTestsBase
    {
        ...
        public void Can_Declare_Time_With_New()
        {
            ...
            var statements = new List<Tuple<string, Type, object, string>>()
            {
                TestCase("result", typeof(double), 1,
                    "var result = 0; var time = new Time(1, 2, 30, 45 ); result = time.Days;"),
                TestCase("result", typeof(double), 2,
                    "var result = 0; var time = new Time(1, 2, 30, 45 ); result = time.Hours;"),
                TestCase("result", typeof(double), 30,
                    "var result = 0; var time = new Time(1, 2, 30, 45 ); result = time.Minutes;"),
                TestCase("result", typeof(double), 45,
                    "var result = 0; var time = new Time(1, 2, 30, 45 ); result = time.Seconds;")
            };
            Parse(statements);
        }
        ...
        public void Can_Add_Times()
        {
            ...
            {
                TestCase("result", typeof(double), 1,
                    "var result = 0; var time1 = new Time(0, 2, 30, 0 ); var time2 = new Time(1, 1, 10, 20); var time3 = time1 + time2; result = time3.Days;"),
                TestCase("result", typeof(double), 3,
                    "var result = 0; var time1 = new Time(0, 2, 30, 0 ); var time2 = new Time(0, 1, 10, 20); var time3 = time1 + time2; result = time3.Hours;"),
                TestCase("result", typeof(double), 40,
                    "var result = 0; var time1 = new Time(0, 2, 30, 0 ); var time2 = new Time(0, 1, 10, 20); var time3 = time1 + time2; result = time3.Minutes;"),
                TestCase("result", typeof(double), 25,
                    "var result = 0; var time1 = new Time(0, 2, 30, 5 ); var time2 = new Time(0, 1, 10, 20); var time3 = time1 + time2; result = time3.Seconds;")
            };
            Parse(statements);
        }
    }
    ...
    public class Types_Array : ScriptTestsBase
    {
        ...
        public void Can_Do_Array_Declarations()
        {
            var statements = new List<Tuple<string, Type, Type, int, string>>()
            {
                ...
                new Tuple<string, Type, Type, int, string>("result", typeof(LArray), typeof(double), 4,
                    "var result = [1.1,  2.2,   3.33, 4.44];"),
                new Tuple<string, Type, Type, int, string>("result", typeof(LArray), typeof(DateTime), 5,
                    "var result = [new Date(),  new Date(), new Date(), new Date(), new Date()];")
            };
        ...
        {
            var maptxt =
                @"[ 'john', 'johndoe@email.com', true, 10.5, new Date(), { City: 'Queens', State: 'NY' }, [0, 1, 2] ]";
            var testcases = new List<Tuple<string, Type, object, string>>()
            {
        ...
        public void Can_Set_Array_ByIndex()
        {
            ...
            {
                TestCase("result", typeof(string), "jane",
                    "var p = " + maptxt + "; p[0] = 'jane';  var result = p[0];"),
                TestCase("result", typeof(string), "janedoe@email.com",
                    "var p = " + maptxt + "; p[1] = 'janedoe@email.com'; var result = p[1];"),
                TestCase("result", typeof(bool), false, "var p = " + maptxt + "; p[2] = false;   var result = p[2];"),
                TestCase("result", typeof(string), "Bronx",
                    "var p = " + maptxt + "; p[5].City = 'Bronx';  var result = p[5].City;"),
                TestCase("result", typeof(string), "NJ",
                    "var p = " + maptxt + "; p[5].State = 'NJ';    var result = p[5].State;")
            };
            RunTestCases(testcases);
        }
        ...
        public void Can_Do_Array_Method_Calls()
        {
            ...
            {
                new Tuple<string, Type, object, int, string>("result", typeof(int), 4, 4,
                    arrytext + " var result = arr.length;"),
                new Tuple<string, Type, object, int, string>("result", typeof(string), "e", 5,
                    arrytext + " arr.push('e'); var result = arr[4];"),
                new Tuple<string, Type, object, int, string>("result", typeof(string), "d", 3,
                    arrytext + " var result = arr.pop();"),
                new Tuple<string, Type, object, int, string>("result", typeof(string), "a;b;c;d", 4,
                    arrytext + " var result = arr.join(';');"),
                new Tuple<string, Type, object, int, string>("result", typeof(string), "d;c;b;a", 4,
                    arrytext + " var result = arr.reverse().join(';');")
            };
            foreach (var stmt in statements)
            {
                var i = new Interpreter();
