...
namespace HSNXT.ComLib.Lang.Tests.Integration.System
{
    ...
    public class Script_Tests_CSharp_Integration : ScriptTestsBase
    {
        ...
        public void Can_Call_Function_Using_Different_Types_Of_Params1()
        {
            ...
            var i = new Interpreter();
            i.Parse(func);
            CompareExpected(12.34,
                i.Call("argsTest", true, 1, 12.34, "fluent script", new DateTime(2012, 8, 10), false,
                    new TimeSpan(9, 30, 25)));
            CompareExpected("fluent script",
                i.Call("argsTest", true, 2, 12.34, "fluent script", new DateTime(2012, 8, 10), false,
                    new TimeSpan(9, 30, 25)));
            CompareExpected(8,
                i.Call("argsTest", true, 3, 12.34, "fluent script", new DateTime(2012, 8, 10), false,
                    new TimeSpan(9, 30, 25)));
            CompareExpected(false,
                i.Call("argsTest", true, 4, 12.34, "fluent script", new DateTime(2012, 8, 10), false,
                    new TimeSpan(9, 30, 25)));
            CompareExpected(9,
                i.Call("argsTest", true, 5, 12.34, "fluent script", new DateTime(2012, 8, 10), false,
                    new TimeSpan(9, 30, 25)));
        }
        ...
        public void Can_Call_Function_Using_Generic_List_Of_Objects()
        {
            ...
            i.Parse(func);
            Console.WriteLine(func);
            CompareExpected("user2",
                i.Call("argsTest", true, 1, new List<User>() {new User("user1"), new User("user2")}));
        }
        ...
        {
            var func =
                "function argsTest(usePropStyle, map) { if(usePropStyle) return map.username; return map['username'];}";
            var i = new Interpreter();
