    ...
    public class ModelTests
    {
        ...
        public void CanIterateDetailed2()
        {
            ...
            ctx.AllModels.Iterate(m => m.GenerateCode,
                ...
                (m) => map[currentModelName + ".CountInheritedModels"] =
                    map[currentModelName + ".CountInheritedModels"] + 1,
                (m, include) => map[currentModelName + ".CountIncludes"] = map[currentModelName + ".CountIncludes"] + 1,
                (m, compose) => map[currentModelName + ".CountCompositions"] =
                    map[currentModelName + ".CountCompositions"] + 1,
                null, null);
