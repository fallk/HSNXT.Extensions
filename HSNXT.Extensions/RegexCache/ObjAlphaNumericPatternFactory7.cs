...
// Type: HSNXT.RegularExpressions.ObjAlphaNumericPatternFactory7
...
{
    internal class ObjAlphaNumericPatternFactory7 : RegexRunnerFactory
    {
        protected override RegexRunner CreateInstance()
        {
            return (RegexRunner) new ObjAlphaNumericPatternRunner7();
        }
    }
}