...
// Type: HSNXT.RegularExpressions.ObjAlphaNumericPatternWhiteFactory8
...
{
    internal class ObjAlphaNumericPatternWhiteFactory8 : RegexRunnerFactory
    {
        protected override RegexRunner CreateInstance()
        {
            return (RegexRunner) new ObjAlphaNumericPatternWhiteRunner8();
        }
    }
}