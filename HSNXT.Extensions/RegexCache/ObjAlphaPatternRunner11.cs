...
// Type: HSNXT.RegularExpressions.ObjAlphaPatternRunner11
...
{
    internal class ObjAlphaPatternRunner11 : RegexRunner
    {
        protected override void Go()
        {
            ...
            if (runtextpos < runtextend)
            {
                ...
                if (RegexRunner.CharInClass(str[index1], "\x0001\x0004\0A[a{"))
                {
                    this.CheckTimeout();
        ...
        protected override bool FindFirstChar()
        {
            ...
            {
                --num1;
                if (RegexRunner.CharInClass(runtext[runtextpos++], "\x0001\x0004\0A[a{"))
                    goto label_4;
            } while (num1 > 0);
