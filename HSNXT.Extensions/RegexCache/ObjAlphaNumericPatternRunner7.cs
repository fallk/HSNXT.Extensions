...
// Type: HSNXT.RegularExpressions.ObjAlphaNumericPatternRunner7
...
{
    internal class ObjAlphaNumericPatternRunner7 : RegexRunner
    {
        protected override void Go()
        {
            ...
            if (runtextpos < runtextend)
            {
                ...
                if (RegexRunner.CharInClass(str[index1], "\x0001\x0006\00:A[a{"))
                {
                    this.CheckTimeout();
        ...
        protected override bool FindFirstChar()
        {
            ...
            {
                --num1;
                if (RegexRunner.CharInClass(runtext[runtextpos++], "\x0001\x0006\00:A[a{"))
                    goto label_4;
            } while (num1 > 0);
