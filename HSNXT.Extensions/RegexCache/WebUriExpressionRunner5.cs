...
namespace HSNXT.RegularExpressions
{
    internal class WebUriExpressionRunner5 : RegexRunner
    {
        protected override void Go()
        {
            ...
            this.CheckTimeout();
            if (4 <= runtextend - runtextpos && (int) runtext[runtextpos] == 104 &&
                ((int) runtext[runtextpos + 1] == 116 && (int) runtext[runtextpos + 2] == 116) &&
                (int) runtext[runtextpos + 3] == 112)
            {
                runtextpos += 4;
                this.CheckTimeout();
            }
            ...
            this.CheckTimeout();
            if (3 <= runtextend - runtextpos && (int) runtext[runtextpos] == 58 &&
                ((int) runtext[runtextpos + 1] == 47 && (int) runtext[runtextpos + 2] == 47))
            {
                runtextpos += 3;
                this.CheckTimeout();
            ...
            if (1 <= runtextend - runtextpos)
            {
                ++runtextpos;
                var num10 = 1;
                while (RegexRunner.CharInClass(runtext[runtextpos - num10--],
                    "\0\x0002\n-.\0\x0002\x0004\x0005\x0003\x0001\x0006\t\x0013\0"))
                {
                    if (num10 <= 0)
                    {
                        ...
                        while (--num12 > 0)
                        {
                            if (!RegexRunner.CharInClass(runtext[runtextpos++],
                                "\0\x0002\n-.\0\x0002\x0004\x0005\x0003\x0001\x0006\t\x0013\0"))
                            {
                                --runtextpos;
                                break;
            ...
            while (true)
            {
                ...
                } while (5 > runtextend - runtextpos ||
                         ((int) runtext[runtextpos] != 104 || (int) runtext[runtextpos + 1] != 116) ||
                         ((int) runtext[runtextpos + 2] != 116 || (int) runtext[runtextpos + 3] != 112 ||
                          (int) runtext[runtextpos + 4] != 115));
