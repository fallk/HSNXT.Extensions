...
// Type: HSNXT.RegularExpressions.ObjAlphaPatternFactory11
...
{
    internal class ObjAlphaPatternFactory11 : RegexRunnerFactory
    {
        protected override RegexRunner CreateInstance()
        {
            return (RegexRunner) new ObjAlphaPatternRunner11();
        }
    }
}