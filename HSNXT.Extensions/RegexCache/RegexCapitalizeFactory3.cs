...
// Type: HSNXT.RegularExpressions.RegexCapitalizeFactory3
...
{
    internal class RegexCapitalizeFactory3 : RegexRunnerFactory
    {
        protected override RegexRunner CreateInstance()
        {
            return (RegexRunner) new RegexCapitalizeRunner3();
        }
    }
}