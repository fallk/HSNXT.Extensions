...
// Type: HSNXT.RegularExpressions.ObjAlphaPatternWhiteRunner9
...
{
    internal class ObjAlphaPatternWhiteRunner9 : RegexRunner
    {
        protected override void Go()
        {
            ...
            if (runtextpos < runtextend)
            {
                ...
                if (RegexRunner.CharInClass(str[index1], "\x0001\x0004\x0001A[a{d"))
                {
                    this.CheckTimeout();
        ...
        protected override bool FindFirstChar()
        {
            ...
            {
                --num1;
                if (RegexRunner.CharInClass(runtext[runtextpos++], "\x0001\x0004\x0001A[a{d"))
                    goto label_4;
            } while (num1 > 0);
