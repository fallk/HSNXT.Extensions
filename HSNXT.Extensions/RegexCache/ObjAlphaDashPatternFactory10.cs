...
// Type: HSNXT.RegularExpressions.ObjAlphaDashPatternFactory10
...
{
    internal class ObjAlphaDashPatternFactory10 : RegexRunnerFactory
    {
        protected override RegexRunner CreateInstance()
        {
            return (RegexRunner) new ObjAlphaDashPatternRunner10();
        }
    }
}