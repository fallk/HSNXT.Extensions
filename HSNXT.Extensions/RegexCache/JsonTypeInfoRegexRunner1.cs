        ...
        protected override void Go()
        {
            ...
            while (true)
            {
                ...
                do
                {
                    this.CheckTimeout();
                    int num8;
                    if (8 <= runtextend - runtextpos && (int) runtext[runtextpos] == 34 &&
                        ((int) runtext[runtextpos + 1] == 95 && (int) runtext[runtextpos + 2] == 95) &&
                        ((int) runtext[runtextpos + 3] == 116 && (int) runtext[runtextpos + 4] == 121 &&
                         ((int) runtext[runtextpos + 5] == 112 && (int) runtext[runtextpos + 6] == 101)) &&
                        (int) runtext[runtextpos + 7] == 34)
                    {
                        num8 = runtextpos + 8;
                        this.CheckTimeout();
                        int num9;
