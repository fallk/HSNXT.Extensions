    ...
    internal class ToLinkRegexRunner4 : RegexRunner
    {
        protected override void Go()
        {
            ...
            while (true)
            {
                ...
                int num28;
                int num29;
                if (4 <= runtextend - end && (int) runtext[end] == 104 &&
                    ((int) runtext[end + 1] == 116 && (int) runtext[end + 2] == 116) && (int) runtext[end + 3] == 112)
                {
                    end += 4;
                    this.CheckTimeout();
                    int num30;
                ...
                this.CheckTimeout();
                if (3 <= runtextend - end && (int) runtext[end] == 58 &&
                    ((int) runtext[end + 1] == 47 && (int) runtext[end + 2] == 47))
                {
                    end += 3;
                    this.CheckTimeout();
                    var numArray3 = runstack;
                ...
                if (1 <= runtextend - end)
                {
                    ++end;
                    var num30 = 1;
                    while (RegexRunner.CharInClass(runtext[end - num30--],
                    ...
                    if (1 <= runtextend - end)
                    {
                            ...
                            "\0\0\n\0\x0002\x0004\x0005\x0003\x0001\x0006\t\x0013\0"))
                        {
                            if (num30 <= 0)
                            {
                                ...
                                while (--num47 > 0)
                                {
                                    if (!RegexRunner.CharInClass(runtext[end++],
                                        "\0\0\n\0\x0002\x0004\x0005\x0003\x0001\x0006\t\x0013\0"))
                                    {
                                        --end;
                                        break;
                ...
                while (true)
                {
                    ...
                    } while (!RegexRunner.CharInClass(str[index4],
                        "\0\x0002\n-.\0\x0002\x0004\x0005\x0003\x0001\x0006\t\x0013\0"));
