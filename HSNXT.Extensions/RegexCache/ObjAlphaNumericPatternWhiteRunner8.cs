...
// Type: HSNXT.RegularExpressions.ObjAlphaNumericPatternWhiteRunner8
...
{
    internal class ObjAlphaNumericPatternWhiteRunner8 : RegexRunner
    {
        protected override void Go()
        {
            ...
            if (runtextpos < runtextend)
            {
                ...
                if (RegexRunner.CharInClass(str[index1], "\x0001\x0006\x00010:A[a{d"))
                {
                    this.CheckTimeout();
        ...
        protected override bool FindFirstChar()
        {
            ...
            {
                --num1;
                if (RegexRunner.CharInClass(runtext[runtextpos++], "\x0001\x0006\x00010:A[a{d"))
                    goto label_4;
            } while (num1 > 0);
