...
namespace HSNXT
{
    public static partial class Extensions
    {
        ...
        {
            return Task.Factory.FromTaskEnumerable(source, keySelector, Enumerable.ThenByDescending, cancellationToken);
        }
        ...
        public static Task<IOrderedEnumerable<TSource>> ThenByDescending<TSource, TKey>(
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            return Task.Factory.FromTaskEnumerable(source, keySelector, comparer, Enumerable.ThenByDescending,
                cancellationToken);
        }
    }
}