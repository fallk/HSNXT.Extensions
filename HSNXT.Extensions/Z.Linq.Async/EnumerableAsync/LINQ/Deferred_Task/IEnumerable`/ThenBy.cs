...
namespace HSNXT
{
    public static partial class Extensions
    {
        ...
        {
            return Task.Factory.FromTaskEnumerable(source, keySelector, Enumerable.ThenBy, cancellationToken);
        }
        ...
        public static Task<IOrderedEnumerable<TSource>> ThenBy<TSource, TKey>(
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            return Task.Factory.FromTaskEnumerable(source, keySelector, comparer, Enumerable.ThenBy, cancellationToken);
        }
    }
}