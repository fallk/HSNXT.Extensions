...
namespace HSNXT
{
    ...
    {
        public static Task<IEnumerable<TSource>> DefaultIfEmpty<TSource>(this Task<IOrderedEnumerable<TSource>> source,
        ...
        public static Task<IEnumerable<TSource>> DefaultIfEmpty<TSource>(this Task<IOrderedEnumerable<TSource>> source,
            TSource defaultValue, CancellationToken cancellationToken = default(CancellationToken))
        {
