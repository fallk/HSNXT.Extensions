...
namespace HSNXT
{
    public static partial class Extensions
    {
        public static Task<IEnumerable<TResult>> Select<TSource, TResult>(
            this Task<AsyncWhereEnumerable<TSource>> source, Func<TSource, TResult> selector,
        ...
        public static Task<IEnumerable<TResult>> Select<TSource, TResult>(
            this Task<AsyncWhereEnumerable<TSource>> source, Func<TSource, int, TResult> selector,
            CancellationToken cancellationToken = default(CancellationToken))
        {
            return Task.Factory.FromTaskEnumerable(source, selector, Enumerable.Select, cancellationToken);
        }
