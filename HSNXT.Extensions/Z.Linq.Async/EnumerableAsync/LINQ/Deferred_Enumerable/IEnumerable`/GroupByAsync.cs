...
namespace HSNXT
{
    public static partial class Extensions
    {
        ...
        public static Task<IEnumerable<IGrouping<TKey, TElement>>> GroupByAsync<TSource, TKey, TElement>(
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            return Task.Factory.FromEnumerable(source, keySelector, elementSelector, Enumerable.GroupBy,
                cancellationToken);
        }
        ...
        {
            return Task.Factory.FromEnumerable(source, keySelector, elementSelector, comparer, Enumerable.GroupBy,
                cancellationToken);
        }

        public static Task<IEnumerable<TResult>> GroupByAsync<TSource, TKey, TResult>(this IEnumerable<TSource> source,
            Func<TSource, TKey> keySelector, Func<TKey, IEnumerable<TSource>, TResult> resultSelector,
            CancellationToken cancellationToken = default(CancellationToken))
        {
            return Task.Factory.FromEnumerable(source, keySelector, resultSelector, Enumerable.GroupBy,
                cancellationToken);
        }
        ...
        public static Task<IEnumerable<TResult>> GroupByAsync<TSource, TKey, TElement, TResult>(
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            return Task.Factory.FromEnumerable(source, keySelector, elementSelector, resultSelector, Enumerable.GroupBy,
                cancellationToken);
        }
        ...
        public static Task<IEnumerable<TResult>> GroupByAsync<TSource, TKey, TResult>(this IEnumerable<TSource> source,
            ...
            IEqualityComparer<TKey> comparer, CancellationToken cancellationToken = default(CancellationToken))
        {
            return Task.Factory.FromEnumerable(source, keySelector, resultSelector, comparer, Enumerable.GroupBy,
                cancellationToken);
        }
        ...
        public static Task<IEnumerable<TResult>> GroupByAsync<TSource, TKey, TElement, TResult>(
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            return Task.Factory.FromEnumerable(source, keySelector, elementSelector, resultSelector, comparer,
