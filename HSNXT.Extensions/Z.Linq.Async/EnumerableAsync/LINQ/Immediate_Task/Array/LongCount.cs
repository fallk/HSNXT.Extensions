...
namespace HSNXT
{
    ...
    {
        public static Task<long> LongCount<TSource>(this Task<TSource[]> source,
            CancellationToken cancellationToken = default(CancellationToken))
        {
            return Task.Factory.FromTaskEnumerable(source, Enumerable.LongCount, cancellationToken);
        }

        public static Task<long> LongCount<TSource>(this Task<TSource[]> source, Func<TSource, bool> predicate,
            CancellationToken cancellationToken = default(CancellationToken))
        {
