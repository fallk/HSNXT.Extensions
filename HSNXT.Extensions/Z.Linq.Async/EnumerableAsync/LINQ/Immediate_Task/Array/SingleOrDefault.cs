...
namespace HSNXT
{
    ...
    {
        public static Task<TSource> SingleOrDefault<TSource>(this Task<TSource[]> source,
            CancellationToken cancellationToken = default(CancellationToken))
        {
            return Task.Factory.FromTaskEnumerable(source, Enumerable.SingleOrDefault, cancellationToken);
        }

        public static Task<TSource> SingleOrDefault<TSource>(this Task<TSource[]> source, Func<TSource, bool> predicate,
            CancellationToken cancellationToken = default(CancellationToken))
        {
