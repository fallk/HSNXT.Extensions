...
namespace HSNXT
{
    ...
    {
        public static Task<TSource> Last<TSource>(this Task<TSource[]> source,
            CancellationToken cancellationToken = default(CancellationToken))
        {
            return Task.Factory.FromTaskEnumerable(source, Enumerable.Last, cancellationToken);
        }

        public static Task<TSource> Last<TSource>(this Task<TSource[]> source, Func<TSource, bool> predicate,
            CancellationToken cancellationToken = default(CancellationToken))
        {
