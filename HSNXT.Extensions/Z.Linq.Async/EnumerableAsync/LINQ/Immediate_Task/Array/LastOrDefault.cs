...
namespace HSNXT
{
    ...
    {
        public static Task<TSource> LastOrDefault<TSource>(this Task<TSource[]> source,
            CancellationToken cancellationToken = default(CancellationToken))
        {
            return Task.Factory.FromTaskEnumerable(source, Enumerable.LastOrDefault, cancellationToken);
        }

        public static Task<TSource> LastOrDefault<TSource>(this Task<TSource[]> source, Func<TSource, bool> predicate,
            CancellationToken cancellationToken = default(CancellationToken))
        {
