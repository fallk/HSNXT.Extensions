...
namespace HSNXT
{
    ...
    {
        public static Task<TSource> First<TSource>(this Task<TSource[]> source,
            CancellationToken cancellationToken = default(CancellationToken))
        {
            return Task.Factory.FromTaskEnumerable(source, Enumerable.First, cancellationToken);
        }

        public static Task<TSource> First<TSource>(this Task<TSource[]> source, Func<TSource, bool> predicate,
            CancellationToken cancellationToken = default(CancellationToken))
        {
