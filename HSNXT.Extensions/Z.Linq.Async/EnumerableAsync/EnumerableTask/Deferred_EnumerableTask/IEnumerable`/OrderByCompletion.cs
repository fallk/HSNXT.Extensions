    ...
    public static partial class Extensions
    {
        ...
        public static Task<T>[] OrderByCompletion<T>(this IEnumerable<Task<T>> tasks)
        {
            ...
            for (var i = 0; i != numTasks; ++i)
            {
                ...
                ret[i] = tcs[i].Task;
                taskArray[i].ContinueWith(continuation, CancellationToken.None,
        ...
        internal static bool TryCompleteFromCompletedTask<TResult>(this TaskCompletionSource<TResult> @this,
            Task<TResult> task)
        {
