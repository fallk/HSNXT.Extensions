...
namespace HSNXT.Reactive
{
    ...
    {
        private const string OBSOLETE_REFACTORING =
        ...
        public const string OBSOLETE_SCHEDULER_NEWTHREAD =
            OBSOLETE_REFACTORING +
            " Please use NewThreadScheduler.Default to obtain an instance of this scheduler type.";

        public const string OBSOLETE_SCHEDULER_TASKPOOL =
            OBSOLETE_REFACTORING +
            " Please use TaskPoolScheduler.Default to obtain an instance of this scheduler type.";

        public const string OBSOLETE_SCHEDULER_THREADPOOL = OBSOLETE_REFACTORING +
                                                            " Consider using Scheduler.Default to obtain the platform's most appropriate pool-based scheduler. In order to access a specific pool-based scheduler, please add a reference to the HSNXT.Reactive.PlatformServices assembly for your target platform and use the appropriate scheduler in the HSNXT.Reactive.Concurrency namespace.";

        public const string OBSOLETE_SCHEDULEREQUIRED =
 ...
 "This blocking operation is no longer supported. Instead, use the async version in combination with C# and Visual Basic async/await support. In case you need a blocking operation, use Wait or convert the resulting observable sequence to a Task object and block.";
        public const string USE_TASK_FROMASYNCPATTERN =
