...
namespace HSNXT.Reactive
{
    internal abstract class TailRecursiveSink<TSource> : Sink<TSource>, IObserver<TSource>
    {
        ...
        public IDisposable Run(IEnumerable<IObservable<TSource>> sources)
        {
            ...
            return StableCompositeDisposable.Create(_subscription, cancelable,
                Disposable.Create(() => _gate.Wait(Dispose)));
        }
        ...
        private bool TryGetEnumerator(IEnumerable<IObservable<TSource>> sources,
