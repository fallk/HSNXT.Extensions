...
//
// WARNING: The full namespace-qualified type name should stay the same for the discovery in HSNXT.Reactive.Core to work!
//
        ...
        public virtual T GetService<T>(object[] args) where T : class
        {
            ...
            if (t == typeof(IQueryServices))
            {
                ...
                if (Debugger.IsAttached)
                {
                    ...
                    asm.Name = "HSNXT.Reactive";
                    var name = "HSNXT.Reactive.Linq.QueryDebugger, " + asm.FullName;
