...
namespace HSNXT.Reactive.Windows.Foundation
{
    /// <summary>
    ...
    public static class AsyncInfoObservableExtensions
    {
        ...
        public static IObservable<Unit> ToObservable(this IAsyncAction source)
        {
            ...
            return new AsyncInfoToObservableBridge<Unit, Unit>(
                source,
                (iai, a) => ((IAsyncAction)iai).Completed +=
 new AsyncActionCompletedHandler((iaa, status) => a(iaa, status)),
                iai => Unit.Default,
                onProgress: null,
                progress: null,
                multiValue: false
        ...
        private static IObservable<Unit> ToObservable_<TProgress>(this IAsyncActionWithProgress<TProgress> source, IProgress<TProgress> progress)
        {
            return new AsyncInfoToObservableBridge<Unit, TProgress>(
                source,
                (iai, a) => ((IAsyncActionWithProgress<TProgress>)iai).Completed +=
 new AsyncActionWithProgressCompletedHandler<TProgress>((iaa, status) => a(iaa, status)),
                iai => Unit.Default,
                (iai, a) => ((IAsyncActionWithProgress<TProgress>)iai).Progress +=
 new AsyncActionProgressHandler<TProgress>((iap, p) => a(iap, p)),
                progress,
                multiValue: false
            );
        }
        ...
        public static IObservable<TResult> ToObservable<TResult>(this IAsyncOperation<TResult> source)
        {
            ...
            return new AsyncInfoToObservableBridge<TResult, Unit>(
                source,
                (iai, a) => ((IAsyncOperation<TResult>)iai).Completed +=
 new AsyncOperationCompletedHandler<TResult>((iao, status) => a(iao, status)),
        ...
        private static IObservable<TResult> ToObservable_<TResult, TProgress>(this IAsyncOperationWithProgress<TResult, TProgress> source, IProgress<TProgress> progress, bool supportsMultiple)
        {
            return new AsyncInfoToObservableBridge<TResult, TProgress>(
                source,
                (iai, a) => ((IAsyncOperationWithProgress<TResult, TProgress>)iai).Completed +=
 new AsyncOperationWithProgressCompletedHandler<TResult, TProgress>((iao, status) => a(iao, status)),
                iai => ((IAsyncOperationWithProgress<TResult, TProgress>)iai).GetResults(),
                (iai, a) => ((IAsyncOperationWithProgress<TResult, TProgress>)iai).Progress +=
 new AsyncOperationProgressHandler<TResult, TProgress>((iap, p) => a(iap, p)),
                progress,
                supportsMultiple
            );
        }
