...
namespace HSNXT.Reactive.Concurrency
{
    ...
    public class ControlScheduler : LocalScheduler, ISchedulerPeriodic
    {
        ...
        /// <remarks>
        /// This scheduler type is typically used indirectly through the <see cref="HSNXT.Reactive.Linq.ControlObservable.ObserveOn{TSource}"/> and <see cref="HSNXT.Reactive.Linq.ControlObservable.SubscribeOn{TSource}"/> method overloads that take a Windows Forms control.
        /// </remarks>
