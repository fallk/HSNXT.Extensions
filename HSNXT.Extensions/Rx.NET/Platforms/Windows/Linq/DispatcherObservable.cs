...
namespace HSNXT.Reactive.Linq
{
    ...
    public static class DispatcherObservable
    {
        ...
        public static IObservable<TSource> ObserveOn<TSource>(this IObservable<TSource> source,
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="dispatcherObject"/> is null.</exception>
        public static IObservable<TSource> ObserveOn<TSource>(this IObservable<TSource> source,
            DispatcherObject dispatcherObject, DispatcherPriority priority)
        {
            if (source == null)
                throw new ArgumentNullException(nameof(source));
            if (dispatcherObject == null)
        ...
        /// </remarks>
        public static IObservable<TSource> SubscribeOn<TSource>(this IObservable<TSource> source,
            DispatcherScheduler scheduler)
        {
            if (source == null)
                throw new ArgumentNullException(nameof(source));
