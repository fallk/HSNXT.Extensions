...
namespace HSNXT.Reactive.Linq
{
    ...
    internal interface IQueryLanguageEx
    {
        ...
        IObservable<TResult> ForkJoin<TFirst, TSecond, TResult>(IObservable<TFirst> first, IObservable<TSecond> second,
        ...
        IObservable<TResult> Let<TSource, TResult>(IObservable<TSource> source,
            Func<IObservable<TSource>, IObservable<TResult>> function);

        IObservable<TResult> ManySelect<TSource, TResult>(IObservable<TSource> source,
