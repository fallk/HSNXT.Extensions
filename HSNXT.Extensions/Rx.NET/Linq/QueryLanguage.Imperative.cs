...
namespace HSNXT.Reactive.Linq
{
    ...
    internal partial class QueryLanguage
    {
        ...
        private static Task ForEachAsync_<TSource>(IObservable<TSource> source, Action<TSource> onNext,
            CancellationToken cancellationToken)
        {
            ...
            if (!cancellationToken.IsCancellationRequested)
            {
                ...
                var taskCompletionObserver = new AnonymousObserver<TSource>(
                    ...
                    exception => { dispose(() => tcs.TrySetException(exception)); },
        ...
        public virtual IObservable<TResult> Case<TValue, TResult>(Func<TValue> selector,
        ...
        public virtual IObservable<TResult> For<TSource, TResult>(IEnumerable<TSource> source,
