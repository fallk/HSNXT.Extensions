...
namespace HSNXT.Reactive.Linq
{
    internal partial class QueryLanguage
    {
        ...
        public virtual IObservable<TSource> ObserveOn<TSource>(IObservable<TSource> source,
        ...
        public virtual IObservable<TSource> SubscribeOn<TSource>(IObservable<TSource> source,
            SynchronizationContext context)
        {
