...
namespace HSNXT.Reactive.Linq.ObservableImpl
{
    internal sealed class
        ToLookup<TSource, TKey, TElement> : Producer<ILookup<TKey, TElement>, ToLookup<TSource, TKey, TElement>._>
    {
        ...
        public ToLookup(IObservable<TSource> source, Func<TSource, TKey> keySelector,
        ...
        protected override _ CreateSink(IObserver<ILookup<TKey, TElement>> observer, IDisposable cancel) =>
