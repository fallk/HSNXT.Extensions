...
namespace HSNXT.Reactive.Linq.ObservableImpl
{
    internal sealed class
        TimeInterval<TSource> : Producer<HSNXT.Reactive.TimeInterval<TSource>, TimeInterval<TSource>._>
    {
        ...
        protected override _ CreateSink(IObserver<HSNXT.Reactive.TimeInterval<TSource>> observer, IDisposable cancel) =>
