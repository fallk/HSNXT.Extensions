...
namespace HSNXT.Reactive.Linq.ObservableImpl
{
    internal static class Timeout<TSource>
    {
        internal sealed class Relative : Producer<TSource, Relative._>
        {
            ...
            public Relative(IObservable<TSource> source, TimeSpan dueTime, IObservable<TSource> other,
        ...
        internal sealed class Absolute : Producer<TSource, Absolute._>
        {
            ...
            public Absolute(IObservable<TSource> source, DateTimeOffset dueTime, IObservable<TSource> other,
                IScheduler scheduler)
            {
                _source = source;
                _dueTime = dueTime;
    ...
    internal sealed class Timeout<TSource, TTimeout> : Producer<TSource, Timeout<TSource, TTimeout>._>
    {
        ...
        public Timeout(IObservable<TSource> source, IObservable<TTimeout> firstTimeout,
            Func<TSource, IObservable<TTimeout>> timeoutSelector, IObservable<TSource> other)
        {
            _source = source;
