...
namespace HSNXT.Reactive.Linq.ObservableImpl
{
    internal sealed class
        GroupBy<TSource, TKey, TElement> : Producer<IGroupedObservable<TKey, TElement>,
            GroupBy<TSource, TKey, TElement>._>
    {
        ...
        public GroupBy(IObservable<TSource> source, Func<TSource, TKey> keySelector,
        ...
        protected override _ CreateSink(IObserver<IGroupedObservable<TKey, TElement>> observer, IDisposable cancel) =>
        ...
        internal sealed class _ : Sink<IGroupedObservable<TKey, TElement>>, IObserver<TSource>
        {
            ...
            public void OnNext(TSource value)
            {
                ...
                try
                {
                    ...
                    //
                    //       // var fireNewMapEntry = false;
                    //       C:\Projects\Rx\Rx\Experimental\Main\Source\Rx\HSNXT.Reactive.Linq\Reactive\Linq\Observable\GroupBy.cs @ 67:
                    //       000007fb`6d544b80 48c7452800000000 mov     qword ptr [rbp+28h],0
                    //
                    //       // var writer = default(ISubject<TElement>);
                    //       C:\Projects\Rx\Rx\Experimental\Main\Source\Rx\HSNXT.Reactive.Linq\Reactive\Linq\Observable\GroupBy.cs @ 66:
                    //       000007fb`6d544b88 c6453400        mov     byte ptr [rbp+34h],0
                    //
                    //       // if (!_map.TryGetValue(key, out writer))
                    //       C:\Projects\Rx\Rx\Experimental\Main\Source\Rx\HSNXT.Reactive.Linq\Reactive\Linq\Observable\GroupBy.cs @ 86:
