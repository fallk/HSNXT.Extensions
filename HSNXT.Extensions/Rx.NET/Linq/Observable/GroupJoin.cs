...
namespace HSNXT.Reactive.Linq.ObservableImpl
{
    internal sealed class
        GroupJoin<TLeft, TRight, TLeftDuration, TRightDuration, TResult> : Producer<TResult,
            GroupJoin<TLeft, TRight, TLeftDuration, TRightDuration, TResult>._>
    {
        ...
        public GroupJoin(IObservable<TLeft> left, IObservable<TRight> right,
        ...
        internal sealed class _ : Sink<TResult>
        {
            ...
            private readonly SortedDictionary<int, IObserver<TRight>> _leftMap =
                new SortedDictionary<int, IObserver<TRight>>();
            ...
            public _(GroupJoin<TLeft, TRight, TLeftDuration, TRightDuration, TResult> parent,
                IObserver<TResult> observer, IDisposable cancel)
