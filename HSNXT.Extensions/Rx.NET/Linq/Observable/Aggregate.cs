...
namespace HSNXT.Reactive.Linq.ObservableImpl
{
    internal sealed class Aggregate<TSource> : Producer<TSource, Aggregate<TSource>._>
    {
        ...
        protected override _ CreateSink(IObserver<TSource> observer, IDisposable cancel) =>
            new _(_accumulator, observer, cancel);
    ...
    internal sealed class Aggregate<TSource, TAccumulate> : Producer<TAccumulate, Aggregate<TSource, TAccumulate>._>
    {
        ...
        public Aggregate(IObservable<TSource> source, TAccumulate seed,
        ...
        protected override _ CreateSink(IObserver<TAccumulate> observer, IDisposable cancel) =>
            new _(_seed, _accumulator, observer, cancel);
        ...
        internal sealed class _ : Sink<TAccumulate>, IObserver<TSource>
        {
            ...
            public _(TAccumulate seed, Func<TAccumulate, TSource, TAccumulate> accumulator,
                IObserver<TAccumulate> observer, IDisposable cancel)
                : base(observer, cancel)
            {
                _accumulator = accumulator;
                _accumulation = seed;
    ...
    internal sealed class
        Aggregate<TSource, TAccumulate, TResult> : Producer<TResult, Aggregate<TSource, TAccumulate, TResult>._>
    {
        private readonly IObservable<TSource> _source;
        private readonly TAccumulate _seed;
        private readonly Func<TAccumulate, TSource, TAccumulate> _accumulator;
