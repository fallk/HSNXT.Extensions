...
namespace HSNXT.Reactive.Linq.ObservableImpl
{
    internal static class SelectMany<TSource, TCollection, TResult>
    {
        internal sealed class ObservableSelector : Producer<TResult, ObservableSelector._>
        {
            ...
            public ObservableSelector(IObservable<TSource> source,
            ...
            internal sealed class _ : Sink<TResult>, IObserver<TSource>
            {
                ...
                public void OnNext(TSource value)
                {
                    ...
                    innerSubscription.Disposable =
                        collection.SubscribeSafe(new InnerObserver(this, value, innerSubscription));
                }
        ...
        internal sealed class ObservableSelectorIndexed : Producer<TResult, ObservableSelectorIndexed._>
        {
            ...
            public ObservableSelectorIndexed(IObservable<TSource> source,
            ...
            internal sealed class _ : Sink<TResult>, IObserver<TSource>
            {
                ...
                public void OnNext(TSource value)
                {
                    ...
                    _group.Add(innerSubscription);
                    innerSubscription.Disposable =
                        collection.SubscribeSafe(new InnerObserver(this, value, index, innerSubscription));
                }
        ...
        internal sealed class EnumerableSelector : Producer<TResult, EnumerableSelector._>
        {
            ...
            public EnumerableSelector(IObservable<TSource> source,
        ...
        internal sealed class EnumerableSelectorIndexed : Producer<TResult, EnumerableSelectorIndexed._>
        {
            ...
            public EnumerableSelectorIndexed(IObservable<TSource> source,
        ...
        internal sealed class TaskSelector : Producer<TResult, TaskSelector._>
        {
            ...
            public TaskSelector(IObservable<TSource> source,
        ...
        internal sealed class TaskSelectorIndexed : Producer<TResult, TaskSelectorIndexed._>
        {
            ...
            public TaskSelectorIndexed(IObservable<TSource> source,
    ...
    internal static class SelectMany<TSource, TResult>
    {
        ...
        internal sealed class ObservableSelectors : ObservableSelector
        {
            ...
            public ObservableSelectors(IObservable<TSource> source, Func<TSource, IObservable<TResult>> selector,
                Func<Exception, IObservable<TResult>> selectorOnError, Func<IObservable<TResult>> selectorOnCompleted)
        ...
        internal sealed class ObservableSelectorsIndexed : ObservableSelectorIndexed
        {
            ...
            public ObservableSelectorsIndexed(IObservable<TSource> source,
                Func<TSource, int, IObservable<TResult>> selector,
                Func<Exception, IObservable<TResult>> selectorOnError, Func<IObservable<TResult>> selectorOnCompleted)
                : base(source, selector)
            {
            ...
            protected override ObservableSelectorIndexed._
                CreateSink(IObserver<TResult> observer, IDisposable cancel) => new _(this, observer, cancel);
