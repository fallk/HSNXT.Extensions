...
namespace HSNXT.Reactive.Linq.ObservableImpl
{
    internal sealed class
        Join<TLeft, TRight, TLeftDuration, TRightDuration, TResult> : Producer<TResult,
            Join<TLeft, TRight, TLeftDuration, TRightDuration, TResult>._>
    {
        ...
        public Join(IObservable<TLeft> left, IObservable<TRight> right,
