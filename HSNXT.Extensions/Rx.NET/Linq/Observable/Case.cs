...
{
    internal sealed class Case<TValue, TResult> : Producer<TResult, Case<TValue, TResult>._>,
        IEvaluatableObservable<TResult>
    {
        ...
        public Case(Func<TValue> selector, IDictionary<TValue, IObservable<TResult>> sources,
