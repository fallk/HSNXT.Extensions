...
namespace HSNXT.Reactive.Linq.ObservableImpl
{
    internal sealed class GroupByUntil<TSource, TKey, TElement, TDuration> : Producer<IGroupedObservable<TKey, TElement>
        , GroupByUntil<TSource, TKey, TElement, TDuration>._>
    {
        ...
        public GroupByUntil(IObservable<TSource> source, Func<TSource, TKey> keySelector,
        ...
        internal sealed class _ : Sink<IGroupedObservable<TKey, TElement>>, IObserver<TSource>
        {
            ...
            public _(GroupByUntil<TSource, TKey, TElement, TDuration> parent,
