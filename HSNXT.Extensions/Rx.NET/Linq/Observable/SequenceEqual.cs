...
namespace HSNXT.Reactive.Linq.ObservableImpl
{
    internal static class SequenceEqual<TSource>
    {
        internal sealed class Observable : Producer<bool, Observable._>
        {
            ...
            public Observable(IObservable<TSource> first, IObservable<TSource> second,
            ...
            protected override _ CreateSink(IObserver<bool> observer, IDisposable cancel) =>
                new _(_comparer, observer, cancel);
        ...
        internal sealed class Enumerable : Producer<bool, Enumerable._>
        {
            ...
            public Enumerable(IObservable<TSource> first, IEnumerable<TSource> second,
                IEqualityComparer<TSource> comparer)
            {
                _first = first;
                _second = second;
