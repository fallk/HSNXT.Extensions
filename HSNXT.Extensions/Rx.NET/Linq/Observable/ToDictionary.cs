...
namespace HSNXT.Reactive.Linq.ObservableImpl
{
    internal sealed class
        ToDictionary<TSource, TKey, TElement> : Producer<IDictionary<TKey, TElement>,
            ToDictionary<TSource, TKey, TElement>._>
    {
        ...
        public ToDictionary(IObservable<TSource> source, Func<TSource, TKey> keySelector,
        ...
        protected override _ CreateSink(IObserver<IDictionary<TKey, TElement>> observer, IDisposable cancel) =>
