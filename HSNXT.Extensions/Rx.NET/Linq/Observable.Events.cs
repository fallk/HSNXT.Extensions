...
namespace HSNXT.Reactive.Linq
{
    public static partial class Observable
    {
        ...
        public static IObservable<EventPattern<object>> FromEventPattern(Action<EventHandler> addHandler,
        ...
        /// </remarks>
        /// <seealso cref="Observable.ToEventPattern"/>
        public static IObservable<EventPattern<TEventArgs>> FromEventPattern<TEventArgs>(object target,
            string eventName)
        {
            if (target == null)
                throw new ArgumentNullException(nameof(target));
        ...
        /// </remarks>
        /// <seealso cref="Observable.ToEventPattern"/>
        public static IObservable<EventPattern<TSender, TEventArgs>> FromEventPattern<TSender, TEventArgs>(Type type,
            string eventName)
        {
            if (type == null)
                throw new ArgumentNullException(nameof(type));
        ...
        /// </remarks>
        /// <seealso cref="Observable.ToEvent"/>
        public static IObservable<TEventArgs> FromEvent<TDelegate, TEventArgs>(Action<TDelegate> addHandler,
            Action<TDelegate> removeHandler)
        {
            if (addHandler == null)
                throw new ArgumentNullException(nameof(addHandler));
        ...
        /// </remarks>
        /// <seealso cref="Observable.ToEvent"/>
        public static IObservable<TEventArgs> FromEvent<TEventArgs>(Action<Action<TEventArgs>> addHandler,
