...
namespace HSNXT.Reactive.Linq
{
    internal partial class QueryLanguage
    {
        ...
        public virtual AsyncSubject<TSource> RunAsync<TSource>(IObservable<TSource> source,
        ...
        public virtual AsyncSubject<TSource> RunAsync<TSource>(IConnectableObservable<TSource> source,
            CancellationToken cancellationToken)
        {
            var s = new AsyncSubject<TSource>();
