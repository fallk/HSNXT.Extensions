...
namespace HSNXT.Reactive.Linq
{
    public static partial class Qbservable
    {
        ...
        public static QueryablePattern<TLeft, TRight> And<TLeft, TRight>(this IQbservable<TLeft> left,
        ...
        public static QueryablePlan<TResult> Then<TSource, TResult>(this IQbservable<TSource> source,
        ...
        public static IQbservable<TResult> When<TResult>(this IQbservableProvider provider,
