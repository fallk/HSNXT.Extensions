...
using HSNXT.Reactive.Threading.Tasks; // needed for doc comments
...
namespace HSNXT.Reactive.Linq
{
    public static partial class Observable
    {
            ...
            IEqualityComparer<TKey> comparer)
        {
            ...
            return s_impl.GroupByUntil<TSource, TKey, TElement, TDuration>(source, keySelector, elementSelector,
            ...
            Func<TLeft, IObservable<TRight>, TResult> resultSelector)
        {
            ...
            return s_impl.GroupJoin<TLeft, TRight, TLeftDuration, TRightDuration, TResult>(left, right,
            ...
            Func<TLeft, TRight, TResult> resultSelector)
        {
            ...
            return s_impl.Join<TLeft, TRight, TLeftDuration, TRightDuration, TResult>(left, right, leftDurationSelector,
        ...
        public static IObservable<TOther> SelectMany<TSource, TOther>(this IObservable<TSource> source,
        ...
        public static IObservable<TResult> SelectMany<TSource, TTaskResult, TResult>(this IObservable<TSource> source,
        ...
        public static IObservable<TSource> SkipWhile<TSource>(this IObservable<TSource> source,
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="predicate"/> is null.</exception>
        public static IObservable<TSource> TakeWhile<TSource>(this IObservable<TSource> source,
            Func<TSource, bool> predicate)
        {
            if (source == null)
                throw new ArgumentNullException(nameof(source));
