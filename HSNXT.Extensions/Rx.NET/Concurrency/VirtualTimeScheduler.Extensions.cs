...
namespace HSNXT.Reactive.Concurrency
{
    ...
    public static class VirtualTimeSchedulerExtensions
    {
        ...
        public static IDisposable ScheduleRelative<TAbsolute, TRelative>(
            this VirtualTimeSchedulerBase<TAbsolute, TRelative> scheduler, TRelative dueTime, Action action)
        ...
        public static IDisposable ScheduleAbsolute<TAbsolute, TRelative>(
            this VirtualTimeSchedulerBase<TAbsolute, TRelative> scheduler, TAbsolute dueTime, Action action)
            where TAbsolute : IComparable<TAbsolute>
        {
            if (scheduler == null)
                throw new ArgumentNullException(nameof(scheduler));
