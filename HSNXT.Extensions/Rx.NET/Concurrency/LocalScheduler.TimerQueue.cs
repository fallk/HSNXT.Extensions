    ...
    public partial class LocalScheduler
    {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance",
            "CA1810:InitializeReferenceTypeStaticFieldsInline", Justification =
                "We can't really lift this into a field initializer, and would end up checking for an initialization flag in every static method anyway (which is roughly what the JIT does in a thread-safe manner).")]
        ...
        private IDisposable Enqueue<TState>(TState state, DateTimeOffset dueTime,
        ...
        private static void UpdateLongTermProcessingTimer()
        {
            ...
            lock (s_gate) */
            {
                ...
                s_nextLongTermTimer.Disposable =
                    ConcurrencyAbstractionLayer.Current.StartTimer(EvaluateLongTermQueue, null, dueCapped);
            }
        }
        ...
        private abstract class WorkItem : IComparable<WorkItem>, IDisposable
        {
            ...
            public int CompareTo(WorkItem /*!*/ other) =>
                Comparer<DateTimeOffset>.Default.Compare(DueTime, other.DueTime);
        ...
        private sealed class WorkItem<TState> : WorkItem
        {
            ...
            public WorkItem(LocalScheduler scheduler, TState state, DateTimeOffset dueTime,
                Func<IScheduler, TState, IDisposable> action)
