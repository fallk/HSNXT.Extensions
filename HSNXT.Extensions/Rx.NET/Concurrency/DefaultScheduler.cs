...
namespace HSNXT.Reactive.Concurrency
{
    ...
    {
        private static readonly Lazy<DefaultScheduler> s_instance =
            new Lazy<DefaultScheduler>(() => new DefaultScheduler());
        ...
        public IDisposable SchedulePeriodic<TState>(TState state, TimeSpan period, Func<TState, TState> action)
        {
            ...
            var cancel = s_cal.StartPeriodicTimer(() => { gate.Wait(() => { state1 = action(state1); }); }, period);
