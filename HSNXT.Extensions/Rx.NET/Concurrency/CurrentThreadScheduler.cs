...
namespace HSNXT.Reactive.Concurrency
{
    ...
    {
        private static readonly Lazy<CurrentThreadScheduler> s_instance =
            new Lazy<CurrentThreadScheduler>(() => new CurrentThreadScheduler());
        ...
        [ThreadStatic] private static SchedulerQueue<TimeSpan> s_threadLocalQueue;

        [ThreadStatic] private static IStopwatch s_clock;
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic",
            Justification = "Now marked as obsolete.")]
