...
namespace HSNXT.Reactive
{
    internal class ObservableQueryProvider : IQbservableProvider, IQueryProvider
    {
        ...
        IQueryable<TElement> IQueryProvider.CreateQuery<TElement>(Expression expression)
        {
            ...
            if (call == null || call.Method.DeclaringType != typeof(Qbservable) ||
            ...
            var res =
                Expression.Call(
                    ...
                    Expression.Call(
                        typeof(Observable).GetMethod(nameof(Observable.ToEnumerable))
        ...
        private static MethodInfo AsQueryable
        {
            get
            {
                if (s_AsQueryable == null)
                    s_AsQueryable = Qbservable.InfoOf<object>(() => Queryable.AsQueryable<object>(null))
    ...
    internal class ObservableQuery<TSource> : ObservableQuery, IQbservable<TSource>
    {
        ...
        class ObservableRewriter : ExpressionVisitor
        {
                ...
                else
                {
                    ...
                    if (firstParameter != null)
                    {
                        ...
                        if (firstParameterType == typeof(IQbservableProvider))
                        {
                            ...
                            //
                            var provider = Expression.Lambda<Func<IQbservableProvider>>(Visit(node.Arguments[0]))
                                .Compile()();
            ...
            private IList<Expression> VisitQbservableOperatorArguments(MethodInfo method,
            ...
            private static Lazy<ILookup<string, MethodInfo>> _observableMethods =
                new Lazy<ILookup<string, MethodInfo>>(() => GetMethods(typeof(Observable)));
            ...
            private static MethodCallExpression FindObservableMethod(MethodInfo method, IList<Expression> arguments)
            {
                ...
                else
                {
                    ...
                    {
                        var mapping =
 (LocalQueryMethodImplementationTypeAttribute)typeInfo.GetCustomAttributes(typeof(LocalQueryMethodImplementationTypeAttribute), false).Single();
                    ...
                    {
                        var mapping =
                            (LocalQueryMethodImplementationTypeAttribute) targetType.GetCustomAttributes(
                                typeof(LocalQueryMethodImplementationTypeAttribute), false)[0];
                        targetType = mapping.TargetType;
                    }
#endif
                ...
                var targetMethod = methods[method.Name]
                    .FirstOrDefault(candidateMethod => ArgsMatch(candidateMethod, arguments, typeArgs));
                if (targetMethod == null)
                    throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture,
                        Strings_Providers.NO_MATCHING_METHOD_FOUND, method.Name, targetType.Name));
