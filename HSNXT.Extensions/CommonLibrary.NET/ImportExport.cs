...
namespace HSNXT.ComLib.ImportExport
{
    ...
    public class ImportExports
    {
        ...
        private readonly IDictionary<string, IImportExportService> _ioServices =
            new Dictionary<string, IImportExportService>();

        private readonly IDictionary<string, IImportExportService> _ioServicesShortName =
            new Dictionary<string, IImportExportService>();
        ...
        public void Register<T>(IValidator validator, bool isReusable, params IMapper<T>[] mappers)
            where T : class, new()
        {
            IImportExportService<T> ioService = new ImportExportService<T>();
