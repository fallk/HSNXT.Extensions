...
namespace HSNXT.ComLib.Feeds
{
    ...
    public class FeedBuilder
    {
        ...
        public static string BuildRss(string feedAuthor, string feedTitle, string feedDescription, string feedUrl,
            IList<IPublishable> posts)
        {
            return BuildAsXml(feedAuthor, feedTitle, feedDescription, feedUrl, posts,
                feed => new Rss20FeedFormatter(feed));
        }
        ...
        /// <param name="feedUrl">The url of the feed</param>
        /// <param name="posts">The feed entries.</param>
        public static string BuildAtom(string feedAuthor, string feedTitle, string feedDescription, string feedUrl,
            IList<IPublishable> posts)
        {
            return BuildAsXml(feedAuthor, feedTitle, feedDescription, feedUrl, posts,
        ...
        public static void BuildRss(string feedAuthor, string feedTitle, string feedDescription, string feedUrl,
            IList<IPublishable> posts, TextWriter writer)
        {
            BuildAsXml(feedAuthor, feedTitle, feedDescription, feedUrl, posts, writer,
                feed => new Rss20FeedFormatter(feed));
        }
        ...
        /// <param name="posts">The feed entries.</param>
        /// <param name="writer">The writer to write the feed to</param>
        public static void BuildAtom(string feedAuthor, string feedTitle, string feedDescription, string feedUrl,
            IList<IPublishable> posts, TextWriter writer)
        {
            BuildAsXml(feedAuthor, feedTitle, feedDescription, feedUrl, posts, writer,
                feed => new Atom10FeedFormatter(feed));
        ...
        /// <param name="feedUrl">The url of the feed</param>
        /// <param name="posts">The feed entries.</param>
        public static SyndicationFeed Build(string feedAuthor, string feedTitle, string feedDescription, string feedUrl,
            IList<IPublishable> posts)
        {
            ...
            {
                var item = new SyndicationItem(post.Title, SyndicationContent.CreateHtmlContent(post.Description), null,
                    post.GuidId, post.UpdateDate);
        ...
        /// <returns></returns>
        public static string BuildAsXml(string feedAuthor, string feedTitle, string feedDescription, string feedUrl,
            IList<IPublishable> posts,
        ...
        /// <param name="formatFetcher">The format fetcher.</param>
        /// <returns></returns>
        public static void BuildAsXml(string feedAuthor, string feedTitle, string feedDescription, string feedUrl,
            IList<IPublishable> posts,
