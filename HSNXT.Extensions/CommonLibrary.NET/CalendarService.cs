...
namespace HSNXT.ComLib.Calendars
{
    ...
    public class CalendarService : ICalendar
    {
        ...
        private readonly IDictionary<int, IDictionary<string, DateTime>> _yearHolidayMap =
            new Dictionary<int, IDictionary<string, DateTime>>();
        ...
        {
            Init(calendarCode, provider, DateTime.Today.Year - forwardBackRange,
                DateTime.Today.Year + forwardBackRange);
        }
        ...
        private bool IsHoliday(IDictionary<string, DateTime> holidayLookup, DateTime date)
        {
            ...
            var isNotHoliday = !holidayLookup.ContainsKey(key) && date.DayOfWeek != DayOfWeek.Saturday &&
