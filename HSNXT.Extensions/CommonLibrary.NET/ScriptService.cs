...
namespace HSNXT.ComLib.Web.ScriptsSupport
{
    ...
    public class ScriptService : IScriptService
    {
        ...
        public void AddJavascript(string name, string url, string location = "footer", string dependsOn = "",
            string version = "")
        {
        ...
        public void AddCss(string name, string url, string location = "footer", string dependsOn = "",
            string version = "")
        {
