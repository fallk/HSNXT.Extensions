...
namespace HSNXT.ComLib.Lang.Types
{
    ...
    {
        private static readonly Dictionary<string, LType> _types = new Dictionary<string, LType>();
        private static readonly Dictionary<string, LType> _sysBasicTypes = new Dictionary<string, LType>();
