...
namespace HSNXT.ComLib.Exceptions
{
    ...
    public class ErrorManager
    {
        ...
        /// <param name="errors">The error results.</param>
        /// <param name="arguments">The arguments.</param>
        private static void InternalHandle(object error, Exception exception, string handler, IErrors errors,
            object[] arguments)
        {
            if (handler == null)
            {
        ...
        public static void Handle(string errorDescriptorKey, ILocalizationResourceProvider resources, IErrors errors,
            Exception ex)
        {
        ...
        /// <param name="ex">The exception to handle.</param>
        /// <param name="args">Array of strings to report in the error.</param>
        public static void Handle(string errorDescriptorKey, ILocalizationResourceProvider resources, Exception ex,
            string[] args)
        {
