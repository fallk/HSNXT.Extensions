    ...
    public class EmailHelper
    {
            ...
            Func<IEmailSettings> settingsCreator = null)
        {
            ...
            settings.IsAuthenticationRequired =
                GetOrDefault(config, emailServiceSectionName, "IsAuthenticationRequired", false);
            settings.AuthenticationUserName =
                GetOrDefault(config, emailServiceSectionName, "AuthenticationUserName", "");
            settings.AuthenticationPassword =
                GetOrDefault(config, emailServiceSectionName, "AuthenticationPassword", "");
