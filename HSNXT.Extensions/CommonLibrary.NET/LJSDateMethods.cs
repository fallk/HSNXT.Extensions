...
namespace HSNXT.ComLib.Lang.Types
{
    ...
    public class LJSDateMethods : LTypeMethods
    {
        ...
        public LJSDateMethods()
        {
            ...
            AddMethod("getTime", "GetTime", typeof(double),
                "Returns the number of milliseconds since midnight Jan 1 1970");
            AddMethod("getTimezoneOffset", "GetTimezoneOffset", typeof(double),
                "Returns the time difference between UTC time and local time in minutes");
            AddMethod("getUTCDate", "GetUtcDate", typeof(double),
                "Returns the day of the month according to universal time (from 1-31)");
            AddMethod("getUTCDay", "GetUtcDay", typeof(double),
                "Returns the day of the week according to universal time (from 0-6)");
            AddMethod("getUTCFullYear", "GetUtcFullYear", typeof(double),
                "Returns the year according to universal time (four digits)");
            AddMethod("getUTCHours", "GetUtcHours", typeof(double),
                "Returns the hour according to universal time (from 0-23)");
            AddMethod("getUTCMilliseconds", "GetUtcMilliseconds", typeof(double),
                "Returns the milliseconds according to universal time (from 0-999)");
            AddMethod("getUTCMinutes", "GetUtcMinutes", typeof(double),
                "Returns the minutes according to universal time (from 0-59)");
            AddMethod("getUTCMonth", "GetUtcMonth", typeof(double),
                "Returns the month according to universal time (from 0-11)");
            AddMethod("getUTCSeconds", "GetUtcSeconds", typeof(double),
            ...
            AddArg("setFullYear", "year", "int", true, "", null, "2011, 2012",
                "An integer representing the day of the month");
            AddArg("setFullYear", "month", "int", false, "", -1, "10, 12",
                "An integer representing the day of the month");
            AddArg("setFullYear", "day", "int", false, "", -1, "15, 25",
                "An integer representing the day of the month");
            AddArg("setMonth", "month", "int", true, "", null, "10, 12",
                "An integer representing the day of the month");
            ...
            AddArg("setHours", "millisec", "int", false, "", -1, "10, 21",
                "An integer representing the day of the month");
            AddArg("setMinutes", "min", "int", true, "", null, "10, 21",
                "An integer representing the day of the month");
            AddArg("setMinutes", "sec", "int", false, "", -1, "10, 21", "An integer representing the day of the month");
            AddArg("setMinutes", "millisec", "int", false, "", -1, "10, 21",
                "An integer representing the day of the month");
            AddArg("setSeconds", "sec", "int", true, "", null, "10, 21",
                "An integer representing the day of the month");
            AddArg("setSeconds", "millisec", "int", false, "", -1, "10, 21",
                "An integer representing the day of the month");
            AddArg("setMilliseconds", "millisec", "int", true, "", null, "10, 21",
                "An integer representing the day of the month");
            ...
            AddProperty(true, true, "Milliseconds", "GetMilliseconds", typeof(double),
                "Returns the number of milliseconds since midnight Jan 1 1970");
        }
        ...
        {
            var date = target.Value;
            return (int) date.ToUniversalTime().DayOfWeek;
        }

        public int GetUtcFullYear(LDate target)
        {
            var date = target.Value;
            return date.ToUniversalTime().Year;
        }
        ...
        public int GetUtcMilliseconds(LDate target)
        {
            var date = target.Value;
            return date.ToUniversalTime().Millisecond;
        }

        public int GetUtcMinutes(LDate target)
        {
            var date = target.Value;
            return date.ToUniversalTime().Minute;
        }

        public int GetUtcMonth(LDate target)
        {
            var date = target.Value;
            return date.ToUniversalTime().Month;
        }

        public int GetUtcSeconds(LDate target)
        {
            var date = target.Value;
            return date.ToUniversalTime().Second;
        }

        public string ToDateString(LDate target)
        {
            var date = target.Value;
        ...
        {
            var date = target.Value;
            return date.ToLocalTime().ToString("ddd MMM dd yyyy");
        }

        public string ToLocaleTimeString(LDate target)
        {
            var date = target.Value;
            return date.ToLocalTime().ToString("hh mm ss");
        }

        public string ToLocaleString(LDate target)
        {
            var date = target.Value;
            return date.ToLocalTime().ToString("ddd MMM dd yyyy hh mm ss");
        }

        public string ToString(LDate target)
        {
            var date = target.Value;
            return date.ToString("ddd MMM dd yyyy hh mm ss");
        }
        ...
        {
            var date = target.Value;
            return date.ToUniversalTime().ToString("ddd MMM dd yyyy hh mm ss");
        }
