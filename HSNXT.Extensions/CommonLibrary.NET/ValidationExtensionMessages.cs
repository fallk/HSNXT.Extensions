...
namespace HSNXT.ComLib
{
    ...
    public class ValidationExtensionMessages
    {
        ...
        public ValidationExtensionMessages(
            string textLessThanMinLength = DefaultValues.DEFAULT_TEXT_LESS_THAN_MIN_LENGTH,
            ...
            string isNotSupplied = DefaultValues.DEFAULT_IS_NOT_SUPPLIED)
        {
            ...
            Guard.IsTrue(textMustContainOnlyChars.Contains("{0}"),
                "Text-must-contain-only-chars message requires a parameter.");
            Guard.IsTrue(textMustContainOnlyCharsAndNumbers.Contains("{0}"),
                "Text-must-contain-chars-and-numbers message requires a parameter.");
        ...
        internal class DefaultValues
        {
            ...
            public const string DEFAULT_TEXT_MUST_CONTAIN_ONLY_CHARS_AND_NUMBERS =
                "Text supplied must only contain chars and numbers {0}";
