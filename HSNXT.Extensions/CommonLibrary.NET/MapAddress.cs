...
namespace HSNXT.ComLib.Maps
{
    ...
    public class GeoAddressViewModel
    {
        ...
        /// <param name="height">The height.</param>
        /// <param name="width">The width.</param>
        public GeoAddressViewModel(Address address, string providerName, string providerSourceUrl,
            string providerApiKey, int width, int height)
        {
    ...
    {
        private static GeoProvider _current = new GeoProvider
        {
            Name = "bing",
            SourceUrl = "http://ecn.dev.virtualearth.net/mapcontrol/mapcontrol.ashx?v=6.2",
            ApiKey = ""
        };
