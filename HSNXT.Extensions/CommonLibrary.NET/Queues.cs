...
namespace HSNXT.ComLib.Queue
{
    ...
    public class Queues
    {
        ...
        /// Named queues.
        /// </summary>
        private static readonly IDictionary<string, IQueueProcessor>
            _queues = new Dictionary<string, IQueueProcessor>();
    ...
    public class QueueStatus
    {
        ...
        public QueueStatus(QueueProcessState state, int countItemsRemaining, DateTime lastProcessDate,
            int numberOfTimesProcessed, TimeSpan elaspedTime, int totalProcessed, int dequeueSize)
        {
            State = state;
