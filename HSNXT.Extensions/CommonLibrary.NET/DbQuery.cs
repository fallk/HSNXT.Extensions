...
namespace HSNXT.ComLib.Data
{
    ...
    public static class DBQuery
    {
        ...
        /// <returns></returns>
        public static IList<T> Query<T>(this IDBHelper dbHelper, string commandText, CommandType commandType,
            string paramName, DbType paramType, object paramValue, IRowMapper<IDataReader, T> rowMapper)
        {
        ...
        /// <param name="rowMapper">The mapper that maps a record to an object.</param>
        /// <returns></returns>
        public static IList<T> QueryNoParams<T>(this IDBHelper dbHelper, string commandText, CommandType commandType,
            IRowMapper<IDataReader, T> rowMapper)
        {
        ...
        /// <returns></returns>
        public static IList<T> Query<T>(this IDBHelper dbHelper, string commandText, CommandType commandType,
            DbParameter[] dbParameters, IRowMapper<IDataReader, T> rowMapper)
        {
        ...
        /// <returns></returns>
        public static Tuple2<IList<T>, TOutputParam> Query<T, TOutputParam>(this IDBHelper dbHelper, string commandText,
            CommandType commandType, DbParameter[] dbParameters,
        ...
        /// <returns></returns>
        public static Tuple2<IList<T>, IDictionary<string, object>> Query<T>(this IDBHelper dbHelper,
            string commandText, CommandType commandType, DbParameter[] dbParameters,
