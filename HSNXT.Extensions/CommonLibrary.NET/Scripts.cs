...
namespace HSNXT.ComLib.Web.ScriptsSupport
{
    ...
    public class Scripts
    {
        ...
        public static void AddJavascript(string name, string url, string location = "footer", string dependsOn = "",
            string version = "")
        {
        ...
        public static void AddCss(string name, string url, string location = "footer", string dependsOn = "",
            string version = "")
        {
