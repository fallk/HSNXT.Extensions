    ...
    public sealed class AggregatePlugin : ExprPlugin
    {
        ...
        public override bool CanHandle(Token current)
        {
            ...
            return next == Tokens.LeftParenthesis ||
                   string.Compare(next.Text, "of", StringComparison.InvariantCultureIgnoreCase) == 0;
        }
        ...
        public override string Grammar =>
            "( avg | min | max | sum | count | number ) ( ( '(' <expression> ')' ) | ( of <expression> ) )";
    ...
    public sealed class AggregateExpr : Expr
    {
        ...
        public override object Evaluate()
        {
            ...
            if (dataSource.Type == LTypes.Array)
                ...
                throw new NotSupportedException(_aggregateType + " not supported for list type of " +
                                                dataSource.GetType());
