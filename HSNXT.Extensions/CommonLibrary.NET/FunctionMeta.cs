...
namespace HSNXT.ComLib.Lang.Core
{
    ...
    public class FunctionMetaData
    {
        ...
        public void AddArg(string name, string type, bool required, string alias, object defaultVal, string examples,
            string desc)
        {
        ...
        /// Total arguments
        /// </summary>
        public int TotalArgs => Arguments == null ? 0 : Arguments.Count;
