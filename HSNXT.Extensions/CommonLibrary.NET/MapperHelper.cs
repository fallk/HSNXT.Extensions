...
namespace HSNXT.ComLib.MapperSupport
{
    ...
    {
        private static readonly IDictionary<Type, Func<string, object>> _propertyTypeMappers =
        ...
        public static void MapTo<T>(T item, int counterOrRefId, IDictionary<string, PropertyInfo> propMap,
            IDictionary data)
        {
        ...
        public static void MapTo<T>(T item, int counterOrRefId, IDictionary<string, PropertyInfo> propMap,
            IDictionary data, IErrors errors)
        {
        ...
        public static void MapTo(object obj, IDictionary data, string namefilter, IErrors errors)
        {
            ...
            var propMap = ReflectionUtils.GetPropertiesAsMap(type,
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.SetProperty, false);
        ...
        public static void MapFrom(object obj, IDictionary<string, string> excludeProps,
            IList<KeyValuePair<string, PropertyInfo>> propMap, Action<string, object> callback)
        {
        ...
        public static void SetProperty(PropertyInfo prop, object item, int counterOrRefId, IErrors errors, object val)
        {
            try
            {
                ...
                if (prop != null)
                {
                    ...
                    if (_propertyTypeMappers.ContainsKey(prop.PropertyType) && val != null &&
