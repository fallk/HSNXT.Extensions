...
namespace HSNXT.ComLib.LocationSupport
{
    ...
    public static class LocationParser
    {
        ...
        /// <returns></returns>
        public static LocationLookUpResult ParseCity(CityLookUp cityLookUp, StateLookUp stateLookUp,
            CountryLookUp countryLookUp, string cityname)
        {
            ...
            result = ParseStateById(LocationLookUpType.City, true, string.Empty, stateLookUp, countryLookUp,
                city.StateId, city.CountryId);
        ...
        /// <returns></returns>
        public static LocationLookUpResult ParseState(StateLookUp stateLookUp, CountryLookUp countryLookUp,
            string stateFullNameOrAbbr)
        {
            ...
            result = ParseStateById(LocationLookUpType.State, true, string.Empty, stateLookUp, countryLookUp, state.Id,
                state.CountryId);
            return result;
        }
        ...
        public static LocationLookUpResult ParseCountry(CountryLookUp countryLookUp, string countryText)
        {
            ...
            if (country == null)
                return new LocationLookUpResult(LocationLookUpType.Country, false, "Unknown country supplied.")
                {
                    Country = countryText
                };
        ...
        /// <returns></returns>
        public static LocationLookUpResult ParseCityWithStateOrCountry(CityLookUp cityLookUp, StateLookUp stateLookUp,
            CountryLookUp countryLookUp, string smallLarge)
        {
            // Validate.
        ...
        /// <returns></returns>
        private static LocationLookUpResult Build(LocationLookUpType lookupType, bool isValid, string message,
        ...
        private static void Build(LocationLookUpResult result, LocationLookUpType lookupType, bool isValid,
            string message, Country country, State state, City city)
        {
