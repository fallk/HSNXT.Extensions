...
namespace HSNXT.ComLib.Lang.Parsing
{
    ...
    public class LexerBase
    {
        ...
        /// </summary>
        public int LineNumber => _pos.Line;


        /// <summary>
        /// The char position on the current line.
        /// </summary>
        public int LineCharPos => _pos.LineCharPosition;


        /// <summary>
        /// Get the positional state of the lexer
        /// </summary>
        public LexerState State => _pos;
        ...
        public ScanTokenResult ScanId(bool advanceFirst, bool setPosAfterToken = true)
        {
            ...
            var success = matched || (valid && _pos.Pos > LAST_POSITION);
        ...
        public ScanTokenResult ScanNumber(bool advanceFirst, bool setPosAfterToken = true)
        {
            ...
            {
                sign = _pos.CurrentChar.ToString();
                ReadChar();
            }
        ...
        /// <returns>Contents of token read.</returns>
        public ScanTokenResult ScanCodeString(char quoteChar, char escapeChar = '\\', bool advanceFirst = true,
            bool setPosAfterToken = true)
        {
            // "name" 'name' "name\"s" 'name\'"
            var buffer = new StringBuilder();
            var totalNewLines = 0;
            var curr = advanceFirst ? ReadChar() : _pos.CurrentChar;
            var next = PeekChar();
            var matched = false;
            while (_pos.Pos <= LAST_POSITION)
            {
        ...
        public ScanTokenResult ScanToNewLine(bool advanceFirst, bool setPosAfterToken = true)
        {
            ...
            // 1. Matched the token
            // 2. Did not match but valid && end_of_file
            var success = matched || _pos.Pos > LAST_POSITION;
        ...
        public ScanTokenResult ScanToPosition(bool from1CharForward, int endPos, bool setPosAfterToken = true)
        {
            ...
            var word = _pos.Text.Substring(start, length);
        ...
        /// <returns></returns>
        public ScanTokenResult ScanWordUntilChars(bool advanceFirst, bool setPosAfterToken = true,
        ...
        /// <param name="setPosAfterToken">True to move position to end space, otherwise past end space.</param>
        /// <returns>Contents of token read.</returns>
        public ScanTokenResult ScanChars(IDictionary<char, bool> validChars, bool advanceFirst,
            bool setPosAfterToken = true)
        {
            // while for function
            var buffer = new StringBuilder();
