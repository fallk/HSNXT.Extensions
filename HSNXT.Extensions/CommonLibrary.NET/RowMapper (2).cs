...
namespace HSNXT.ComLib.Data
{
    ...
    public abstract class RowMapperTableBased<T> : RowMapperBaseWithCallBacks<DataTable, T, int>,
        IRowMapper<DataTable, T>
    {
        /// <summary>
    ...
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public abstract class RowMapperReaderBased<T> : RowMapperBaseWithCallBacks<IDataReader, T, int>,
        IRowMapper<IDataReader, T>
    {
        /// <summary>
    ...
    public class RowMapperHelper
    {
        ...
        /// <returns></returns>
        public static IList<T> MapRows<T>(string connection, string sql, Func<DataTable, int, T> rowmapper,
            Action<IList<T>> onAfterRowsMapped = null)
        {
        ...
        /// <param name="onAfterRowsMapped"></param>
        /// <returns></returns>
        public static IList<T> MapRows<T>(DataTable table, Func<DataTable, int, T> rowmapper,
            Action<IList<T>> onAfterRowsMapped = null)
        {
            IList<T> records = new List<T>();
            for (var ndx = 0; ndx < table.Rows.Count; ndx++)
        ...
        /// <param name="onAfterRowsMapped"></param>
        /// <returns></returns>
        public static IList<T> MapRows<T>(IDataReader reader, Func<IDataReader, int, T> rowmapper,
            Action<IList<T>> onAfterRowsMapped = null)
        {
            IList<T> records = new List<T>();
            var ndx = 0;
        ...
        /// <param name="onAfterRowsMapped"></param>
        /// <returns></returns>
        public static IList<T> MapRows<T>(string connection, string sql, Func<IDataReader, int, T> rowmapper,
            Action<IList<T>> onAfterRowsMapped = null)
        {
            var db = new Database(connection);
            IList<T> records = new List<T>();
