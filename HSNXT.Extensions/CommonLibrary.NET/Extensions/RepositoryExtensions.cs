...
namespace HSNXT
{
    public static partial class Extensions
    {
        ...
        public static T Get<T, TRelation>(this IRepository<T> repo, int id, string foreignKey)
            where TRelation : class where T : class
        {
        ...
        /// <returns>Specified entity.</returns>
        public static T Get<T, TRelation>(this IRepository<T> repo, int id, string foreignKey, int pageIndex,
            int pageSize) where T : class where TRelation : class
        {
            var entity = repo.Get(id);
