    ...
    public static partial class Extensions
    {
        ...
        public static T ToNumber<T>(string txt, Func<string, T> callback, T defaultValue)
        {
            ...
            if (trimed.StartsWith("$") ||
                trimed.StartsWith(Thread.CurrentThread.CurrentCulture.NumberFormat.CurrencySymbol))
            {
        ...
        {
            return (!txt.IsNullOrEmpty()) && (txt.ReplaceChars("0123456789ABCDEFabcdef", "                      ")
                       .Trim().IsNullOrEmpty());
        }
        ...
        public static bool IsNotApplicableValue(this string val, bool useNullOrEmptyStringAsNotApplicable = false)
        {
            ...
            if (val == "na" || val == "n.a." || val == "n/a" || val == "n\\a" || val == "n.a" ||
                val == "not applicable")
                return true;
            return false;
        }
