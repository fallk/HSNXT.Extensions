...
namespace HSNXT.ComLib.Lang.Templating
{
    /// <summary>
    ...
    public class TemplateEngineDefault : ITemplateEngine
    {
        ...
        private readonly char TEMPLATE_START = '<';
        private readonly char TEMPLATE_END = '>';
        private readonly char CODE_START = '%';
        private readonly char CODE_END = '%';
        private readonly char EXP_START = '=';
        private readonly char EXP_END = '%';
        private readonly char COMMENT_START = '#';
        private readonly char COMMENT_END = '%';
        private readonly string NEW_LINE = "\"\\r\\n\"";
        private readonly string BUFFER_NAME = "buffer";
        ...
        class CodeBlock
        {
            ...
            /// </summary>
            public readonly State TextType;
        ...
        /// </summary>
        /// <returns></returns>
        private string ReadUntil(char expected1, char expected2, bool advanceFirst = true, int advanceCount = 1,
            bool readToEndOfExpected = true, bool excludeBeginningSpace = true)
        {
        ...
        /// <returns></returns>
        private string ReadCodeBlock(char expected1, char expected2, bool advanceFirst = true, int advanceCount = 1,
            bool readToEndOfExpected = true, bool excludeBeginningSpace = true)
        {
            // starting at @ so move 1 char forward
            if (advanceFirst) _pos += advanceCount;
