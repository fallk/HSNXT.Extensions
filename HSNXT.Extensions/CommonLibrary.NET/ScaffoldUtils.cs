...
namespace HSNXT.ComLib.Scaffolding
{
    public class ScaffoldUtils
    {
        ...
        /// <returns></returns> 
        public Table BuildEntityUITable(string entityName, string clientId, bool loadEntityValues, object entityObject,
            StringDictionary propertiesToExclude)
        {
        ...
        /// <param name="clientId"></param>
        /// <returns></returns>
        public IList<KeyValuePair<string, string>> GetValuesFromUI(string entityName, string clientId,
            StringDictionary propsToExclude)
        {
        ...
        /// <returns></returns>
        private TableRow CreatePropertyRow(PropertyInfo property, string cliendId, bool usePropertyValue,
