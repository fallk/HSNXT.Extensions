...
namespace HSNXT.ComLib.Lang.AST
{
    ...
    public class ParameterExpr : Expr, IParameterExpression
    {
        ...
        {
            var hasParams = this.ParamList != null && this.ParamList.Count > 0;
            ...
            if (hasParams && this.ParamList.Count <= index)
                throw BuildRunTimeException("Unexpected parameter retrieval attempted in custom function plugin : " +
                                            this._fmeta.Name);
