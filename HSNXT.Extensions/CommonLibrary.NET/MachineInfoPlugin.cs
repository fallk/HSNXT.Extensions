...
namespace HSNXT.ComLib.Lang.Plugins
{
    ...
    ***************************************************************************/
    ...
    {
        private static readonly IDictionary<string, bool> _map;
        ...
        /// </summary>
        public override string Grammar => "( (mac '.' ) | '@' ) <ident>";
    ...
    {
        private static readonly IDictionary<string, Func<string>> _map;
