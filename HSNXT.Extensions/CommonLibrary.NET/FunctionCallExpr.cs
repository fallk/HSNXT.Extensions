...
namespace HSNXT.ComLib.Lang.AST
{
    ...
    public class FunctionCallExpr : Expr, IParameterExpression
    {
        ...
        public override object DoEvaluate()
        {
            ...
            {
                result = FunctionHelper.CallMemberOnBasicType(this.Ctx, this, maccess, this.ParamListExpressions,
                    this.ParamList);
            }
        ...
        {
            if (maccess.IsInternalExternalFunctionCall()
                || (maccess.Mode == MemberMode.MethodMember ||
                    maccess.Mode == MemberMode.PropertyMember && maccess.Type != null)
