...
namespace HSNXT.ComLib.Arguments
{
    ...
    public class ArgsSchema
    {
        ...
        /// <returns></returns>
        public ArgsSchema AddNamed<T>(string name, string alias = "", bool isRequired = false, T defaultValue = default,
            string description = "",
            string example = "", string exampleMultiple = "", bool interpret = false, bool isCaseSensitive = false,
            string tag = "", bool onlyForDevelopment = false)
        {
            return Add(-1, name, alias, isRequired, defaultValue, description, example, exampleMultiple, interpret,
                isCaseSensitive, tag, onlyForDevelopment);
        }
        ...
        /// <param name="onlyForDevelopment">Whether or not the argument is only for development purposes</param>
        /// <returns></returns>
        public ArgsSchema AddPositional<T>(int indexPosition, bool isRequired = false, T defaultValue = default,
            string description = "",
            string example = "", string exampleMultiple = "", bool interpret = false, bool isCaseSensitive = false,
            string tag = "", bool onlyForDevelopment = false)
        {
            return Add(indexPosition, string.Empty, string.Empty, isRequired, defaultValue, description, example,
                exampleMultiple, interpret, isCaseSensitive, tag, onlyForDevelopment);
        }


        private ArgsSchema Add<T>(int indexPosition, string name, string alias, bool isRequired, T defaultValue,
            string description, string example, string exampleMultipe, bool interpret,
        ...
        {
            return SetLastArgProperty(arg =>
            {
                arg.Example = singleExample;
                arg.ExampleMultiple = multipleExamples;
            });
        }
