...
namespace HSNXT.ComLib
{
    ...
    public class BoolResult<T> : BoolMessageItem<T>
    {
        ...
        /// Empty false result.
        /// </summary>
        public static new readonly BoolResult<T> False =
            new BoolResult<T>(default, false, string.Empty, ValidationResults.Empty);


        /// <summary>
        /// Empty True result.
        /// </summary>
        public static new readonly BoolResult<T> True =
            new BoolResult<T>(default, true, string.Empty, ValidationResults.Empty);
