...
namespace HSNXT.ComLib.Arguments
{
    ...
    public partial class Args
    {
        ...
        public static void InitServices(Func<string, List<string>> stringParser,
            Func<string, string> substitutor = null)
        {
        ...
        public static BoolMessageItem<Args> Parse(string text)
        {
            ...
            if (_stringParser == null)
                return new BoolMessageItem<Args>(null, false, "Parser for text based args not initialized.");
