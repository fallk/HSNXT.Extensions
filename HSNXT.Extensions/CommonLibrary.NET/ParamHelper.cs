...
namespace HSNXT.ComLib.Lang.Helpers
{
    ...
    public class ParamHelper
    {
        ...
        public static void ResolveParameters(int totalParams, List<Expr> paramListExpressions, List<object> paramList,
            Func<NamedParamExpr, int> indexLookup)
        {
            if (paramListExpressions == null || paramListExpressions.Count == 0)
                return;
        ...
        /// Resolve the parameters in the function call.
        /// </summary>
        public static void ResolveParametersForScriptFunction(FunctionMetaData meta, List<Expr> paramListExpressions,
        ...
        /// Resolve the parameters in the function call.
        /// </summary>
        public static void ResolveParametersForMethodCall(MethodInfo method, List<Expr> paramListExpressions,
            List<object> paramList)
        {
