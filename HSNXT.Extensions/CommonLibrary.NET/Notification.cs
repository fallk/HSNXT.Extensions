...
namespace HSNXT.ComLib.Notifications
{
    ...
    public class Notifier
    {
        ...
        public static void SendToFriend(string toEmail, string subject, string friendName, string fromName,
        ...
        {
            _messageNotifyService.SendToFriendPost(toEmail, subject, toFirstname, fromName, messageToFriend, postTitle,
                postUrl);
        }
        ...
        /// <param name="username">Username of user.</param>
        /// <param name="password">Password of user.</param>
        public static void RemindUserPassword(string to, string subject, string firstname, string username,
            string password)
        {
