...
namespace HSNXT.ComLib.LocationSupport
{
    ...
    public class CountryRepository : RepositorySql<Country>
    {
        ...
        {
            var sql =
                "insert into Countrys ( [CreateDate], [UpdateDate], [CreateUser], [UpdateUser], [UpdateComment], [CountryCode]"
        ...
        {
            var sql =
                "update Countrys set [CreateDate] = @CreateDate, [UpdateDate] = @UpdateDate, [CreateUser] = @CreateUser, [UpdateUser] = @UpdateUser, [UpdateComment] = @UpdateComment, [CountryCode] = @CountryCode"
                + ", [Name] = @Name, [Abbreviation] = @Abbreviation, [AliasRefName] = @AliasRefName, [IsActive] = @IsActive, [IsAlias] = @IsAlias, [AliasRefId] = @AliasRefId where Id = " +
                entity.Id;
            var dbparams = BuildParams(entity);
        ...
        protected virtual DbParameter[] BuildParams(Country entity)
        {
            ...
            dbparams.Add(BuildParam("@CountryCode", SqlDbType.NVarChar,
                string.IsNullOrEmpty(entity.CountryCode) ? "" : entity.CountryCode));
    ...
    public class CountryRowMapper : EntityRowMapper<Country>, IEntityRowMapper<Country>
    {
        ...
        public override Country MapRow(IDataReader reader, int rowNumber)
        {
            ...
            entity.CountryCode =
                reader["CountryCode"] == DBNull.Value ? string.Empty : reader["CountryCode"].ToString();
