...
namespace HSNXT.ComLib.Lang.Parsing
{
    ...
    {
        private readonly IDictionary<string, List<Action<object, AstNode>>> _subscribers =
            new Dictionary<string, List<Action<object, AstNode>>>();


        /// <summary>
        /// Whether or not there are any subscribers.
        /// </summary>
        public bool HasAny => _subscribers.Count > 0;
