...
namespace HSNXT.ComLib.Data
{
    ...
    public class Database : IDatabase
    {
        ...
        /// </example>
        /// <returns></returns>
        public virtual TResult Execute<TResult>(string commandText, CommandType commandType, DbParameter[] dbParameters,
        ...
        /// </example>
        /// <returns></returns>
        public virtual TResult ExecuteProc<TResult>(string commandText, DbParameter[] dbParameters,
            Func<DbCommand, TResult> executor)
        {
