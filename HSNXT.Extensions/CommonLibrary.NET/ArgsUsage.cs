...
namespace HSNXT.ComLib.Arguments
{
    ...
    public class ArgsUsage
    {
        ...
        /// <returns></returns>
        public static List<string> BuildSampleRuns(string appName, IList<ArgAttribute> argAttributes, string prefix,
            string separator)
        {
            ...
            var examples = new List<string>
            {
                ...
                appName + " " + requiredNamedSample + " " + optionalNamedSample + " " + requiredIndexSample + " " +
                optionalIndexSample
            };
            return examples;
        }
        ...
        /// <returns></returns>
        public static string BuildDescriptive(IList<ArgAttribute> argAttributes, IList<string> examples, string prefix,
            string separator)
        {
            // Check Args.
            if (string.IsNullOrEmpty(prefix)) prefix = "-";
        ...
        /// <param name="separator"></param>
        /// <returns></returns>
        public static string BuildArgs(int paddingLength, IList<ArgAttribute> argAttributes, string prefix,
            string separator)
        {
            var usage = Build(argAttributes, arg =>
            {
                ...
                info += string.Format(padding + "{0}, {1}, {2}, default: {3}", required, arg.DataType.Name,
                            caseSensitivity, defaultValue) + Environment.NewLine;
