...
namespace HSNXT.ComLib.Lang.Parsing
{
    ...
    public class SemActs
    {
        ...
        private readonly Dictionary<string, List<Action<SemActs, AstNode>>> _validators;
        ...
        /// The results
        /// </summary>
        public SemActsResults Results => _results;
        ...
        {
            var error = errorText + " at line : " + node.Ref.Line + ", pos : " + node.Ref.CharPos;
        ...
        private void CheckDivisionByZero(SemActs semActs, BinaryExpr exp)
        {
            ...
            var val = ((ConstantExpr) exp.Right).Value;
