...
namespace HSNXT.ComLib.LocationSupport
{
    ...
    public class LocationHelper
    {
        ...
        /// <returns></returns>
        public static bool IsValidStateCountryRelation(StateLookUp stateLookUp, CountryLookUp countryLookUp,
        ...
        /// <param name="stateLookup"></param>
        /// <param name="countryLookup"></param>
        public static void ApplyCity(Address address, CityLookUp cityLookup, StateLookUp stateLookup,
        ...
        public static bool ApplyState(Address address, StateLookUp stateLookup, IList<string> errors)
        {
            ...
            var state = isCountryIdEmpty
                ? stateLookup[address.State]
                : stateLookup.FindByCountry(address.State, address.CountryId);
        ...
        public static bool ApplyCountry(Address address, CountryLookUp countryLookup, IList<string> errors,
            bool useAliasIfApplicable = false)
        {
        ...
        public static BoolMessage ApplyCountryState(City city)
        {
            ...
            // Check state.
            var state = Location.Service.StatesList
                .Where(s => s.CountryId == country.RealId && string.Compare(s.Name, city.StateName, true) == 0)
                .FirstOrDefault();
