...
namespace HSNXT.ComLib.Lang.Types
{
    ...
    public class LTypeMethods : ITypeMethods
    {
        ...
        public void AddProperty(bool allowGet, bool allowSet, string name, string implementationMethod, Type returnType,
            string description)
        {
        ...
        public void AddArg(string funcName, string name, string type, bool required, string alias, object defaultVal,
            string examples, string desc)
        {
        ...
        public virtual object ExecuteMethod(LObject obj, string methodName, object[] parameters)
        {
            ...
            if (total > 0 && hasParams)
            {
                ...
                foreach (var arg in funcDef.Arguments)
                {
                    ...
                    else if (!isRequired && arg.DefaultValue == null && arg.Name == "params" &&
                             ndx >= parameters.Length)
                    {
                        methodArgs.Add(null);
                    }
        ...
        /// <param name="description">Description of the function.</param>
        /// <returns></returns>
        private FunctionMetaData AddMethodInfo(MemberTypes memberType, string name, string implementationMethod,
            Type returnType, string description)
        {
