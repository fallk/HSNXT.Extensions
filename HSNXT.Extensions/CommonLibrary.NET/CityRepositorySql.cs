...
namespace HSNXT.ComLib.LocationSupport
{
    ...
    public class CityRepository : RepositorySql<City>
    {
        ...
        {
            var sql =
                "insert into Citys ( [CreateDate], [UpdateDate], [CreateUser], [UpdateUser], [UpdateComment], [StateId]"
        ...
        {
            var sql =
                "update Citys set [CreateDate] = @CreateDate, [UpdateDate] = @UpdateDate, [CreateUser] = @CreateUser, [UpdateUser] = @UpdateUser, [UpdateComment] = @UpdateComment, [StateId] = @StateId"
                + ", [StateName] = @StateName, [ParentId] = @ParentId, [IsPopular] = @IsPopular, [CountryId] = @CountryId, [CountryName] = @CountryName, [Name] = @Name"
                + ", [Abbreviation] = @Abbreviation, [AliasRefName] = @AliasRefName, [IsActive] = @IsActive, [IsAlias] = @IsAlias, [AliasRefId] = @AliasRefId where Id = " +
                entity.Id;
            var dbparams = BuildParams(entity);
        ...
        protected virtual DbParameter[] BuildParams(City entity)
        {
            ...
            dbparams.Add(BuildParam("@CreateUser", SqlDbType.NVarChar,
                string.IsNullOrEmpty(entity.CreateUser) ? "" : entity.CreateUser));
            dbparams.Add(BuildParam("@UpdateUser", SqlDbType.NVarChar,
                string.IsNullOrEmpty(entity.UpdateUser) ? "" : entity.UpdateUser));
            dbparams.Add(BuildParam("@UpdateComment", SqlDbType.NVarChar,
                string.IsNullOrEmpty(entity.UpdateComment) ? "" : entity.UpdateComment));
            dbparams.Add(BuildParam("@StateId", SqlDbType.Int, entity.StateId));
            dbparams.Add(BuildParam("@StateName", SqlDbType.NVarChar,
                string.IsNullOrEmpty(entity.StateName) ? "" : entity.StateName));
            ...
            dbparams.Add(BuildParam("@CountryName", SqlDbType.NVarChar,
                string.IsNullOrEmpty(entity.CountryName) ? "" : entity.CountryName));
            dbparams.Add(BuildParam("@Name", SqlDbType.NVarChar, string.IsNullOrEmpty(entity.Name) ? "" : entity.Name));
            dbparams.Add(BuildParam("@Abbreviation", SqlDbType.NVarChar,
                string.IsNullOrEmpty(entity.Abbreviation) ? "" : entity.Abbreviation));
            dbparams.Add(BuildParam("@AliasRefName", SqlDbType.NVarChar,
                string.IsNullOrEmpty(entity.AliasRefName) ? "" : entity.AliasRefName));
    ...
    public class CityRowMapper : EntityRowMapper<City>, IEntityRowMapper<City>
    {
        ...
        public override City MapRow(IDataReader reader, int rowNumber)
        {
            ...
            entity.CreateDate = reader["CreateDate"] == DBNull.Value
                ? DateTime.MinValue
                : (DateTime) reader["CreateDate"];
            entity.UpdateDate = reader["UpdateDate"] == DBNull.Value
                ? DateTime.MinValue
                : (DateTime) reader["UpdateDate"];
            entity.CreateUser = reader["CreateUser"] == DBNull.Value ? string.Empty : reader["CreateUser"].ToString();
            entity.UpdateUser = reader["UpdateUser"] == DBNull.Value ? string.Empty : reader["UpdateUser"].ToString();
            entity.UpdateComment = reader["UpdateComment"] == DBNull.Value
                ? string.Empty
                : reader["UpdateComment"].ToString();
            ...
            entity.CountryName =
                reader["CountryName"] == DBNull.Value ? string.Empty : reader["CountryName"].ToString();
            entity.Name = reader["Name"] == DBNull.Value ? string.Empty : reader["Name"].ToString();
            entity.Abbreviation = reader["Abbreviation"] == DBNull.Value
                ? string.Empty
                : reader["Abbreviation"].ToString();
            entity.AliasRefName = reader["AliasRefName"] == DBNull.Value
                ? string.Empty
                : reader["AliasRefName"].ToString();
