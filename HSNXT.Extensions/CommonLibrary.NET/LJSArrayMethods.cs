...
namespace HSNXT.ComLib.Lang.Types
{
    ...
    public class LJSArrayMethods : LTypeMethods
    {
        ...
        public LJSArrayMethods()
        {
            ...
            AddMethod("concat", "Concat", typeof(LArray),
            ...
            AddArg("indexOf", "start", "int", false, "", 0, "0 | 5",
                "Where to start the search. Negative values will start at the given position counting from the end, and search to the end");
            AddArg("join", "separator", "string", false, "", ",", "abc",
                "The separator to be used. If omitted, the elements are separated with a comma");
            AddArg("lastIndexOf", "item", "object", true, "", null, "abc", "The item to search for");
            AddArg("lastIndexOf", "start", "int", false, "", 0, "0 | 4",
                "Where to start the search. Negative values will start at the given position counting from the end, and search to the beginning");
            AddArg("push", "items", "params", true, "", null, "abc", "The items(s) to add to the array");
            AddArg("slice", "start", "int", true, "", null, "0",
            ...
            AddArg("slice", "end", "int", false, "", null, "1",
            ...
            AddArg("splice", "index", "int", true, "", null, "1",
            ...
            AddArg("splice", "howmany", "int", true, "", null, "2",
            ...
            AddArg("unshift", "items", "list", true, "", null, "'abc', 'def'",
                "The item(s) to add to the beginning of the array");
        }
