...
namespace HSNXT.ComLib.Diagnostics
{
    ...
    public class DiagnosticsService : IDiagnosticsService
    {
        ...
        private readonly IDictionary<string, Func<IDictionary>> _diagnosticsRetrievers =
            new SortedDictionary<string, Func<IDictionary>>();
        ...
        public void WriteInfo(string filePath)
        {
            ...
            {
                Console.WriteLine("Unable to write diagnostic information to file : " + filePath);
            }
        }
        ...
        protected void WriteInfoInternal(string path, string referenceMessage)
        {
            ...
            {
                Console.WriteLine("Unable to write diagnostic information to file : " + path);
            }
        }
