...
namespace HSNXT.CommonLibrary
{
    ...
    public class KeyValueValidatingStringParser : KeyValueStringParser, IKeyValueParserValidating<string, string>
    {
        ...
        /// <returns></returns>
        protected override KeyValueData<string, string> InternalParseLine(string text, string delimeter,
            bool applySettings)
        {
    ...
    public class KeyValueStringParser : IKeyValueParser<string, string>
    {
        ...
        protected virtual KeyValueData<string, string> InternalParseLine(string text, string delimeter,
            bool applySettings)
        {
