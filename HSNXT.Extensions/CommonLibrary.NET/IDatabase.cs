...
namespace HSNXT.ComLib.Data
{
    ...
    public interface IDBHelper
    {
        ...
        /// <returns></returns>
        TResult Execute<TResult>(string commandText, CommandType commandType, DbParameter[] dbParameters,
        ...
        /// <param name="dbParameters"></param>
        /// <returns></returns>
        void ExecuteReader(string commandText, CommandType commandType, Action<IDataReader> action,
