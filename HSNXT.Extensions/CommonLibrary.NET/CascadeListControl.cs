...
namespace HSNXT.ComLib.Web.UI.Controls
{
    ...
    public class CascadeDropDownListControl : WebControl, INamingContainer, IPostBackDataHandler
    {
        ...
        protected string BuildClientSideJavascript()
        {
            ...
            buffer.Append(_jsObjectName + ".RetrieveAllService = \"" + UrlRetrieveAllService + "\";" +
                          Environment.NewLine);
            buffer.Append(_jsObjectName + ".ResultTagName = \"" + ResultTagName + "\";" + Environment.NewLine);
            buffer.Append(_jsObjectName + ".JSOnSelectionChangedHandlerName = \"" +
                          OnSelectionChangedClientSideHandler + "\";" + Environment.NewLine);
            buffer.Append(_jsObjectName + ".FilterValueFromState = \"" + SelectedValue + "\";" + Environment.NewLine);
            buffer.Append(_jsObjectName + ".UseIdForFilterValue = " + ConvertToJSBoolean(UseIdForFilterValue) + ";" +
                          Environment.NewLine);
            ...
            buffer.Append(_jsObjectName + ".HiddenSelectedItemId = \"" + HiddenSelectedId + "\";" +
                          Environment.NewLine);
