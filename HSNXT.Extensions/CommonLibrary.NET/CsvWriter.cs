...
namespace HSNXT.ComLib.CsvParse
{
    ...
    public class CsvWriter : IDisposable
    {
        ...
        public CsvWriter(string fileName, List<List<object>> data, string delimeter, List<string> columns,
            bool firstRowInDataAreColumns, bool quoteAll, string quoteChar, string newLine, bool append)
        {
        ...
        /// <param name="newLine">New line to use.</param>
        public void Init(string fileName, List<List<object>> data, string delimeter, List<string> columns,
            bool firstRowInDataAreColumns, bool quoteAll, string quoteChar, string newLine, bool append)
        {
            _filename = fileName;
            _columns = columns;
