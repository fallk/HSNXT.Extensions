...
namespace HSNXT.ComLib.CaptchaSupport
{
    ...
    public class CaptchaGenerator : ICaptchaGenerator
    {
        ...
        public Bitmap Generate(string randomText)
        {
            ...
            objGraphicsPath.AddString(randomText, font.FontFamily, (int) font.Style, font.Size, rectangle,
                objStringFormat);
            var flV = 4F;
            ...
            PointF[] arrPoints =
            {
                ...
                new PointF(_random.Next(rectangle.Width) / flV,
                    rectangle.Height - _random.Next(rectangle.Height) / flV),
                new PointF(rectangle.Width - _random.Next(rectangle.Width) / flV,
                    rectangle.Height - _random.Next(rectangle.Height) / flV)
            };
