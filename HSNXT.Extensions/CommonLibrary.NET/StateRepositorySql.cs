...
namespace HSNXT.ComLib.LocationSupport
{
    ...
    public class StateRepository : RepositorySql<State>
    {
        ...
        {
            var sql =
                "insert into States ( [CreateDate], [UpdateDate], [CreateUser], [UpdateUser], [UpdateComment], [CountryId]"
        ...
        {
            var sql =
                "update States set [CreateDate] = @CreateDate, [UpdateDate] = @UpdateDate, [CreateUser] = @CreateUser, [UpdateUser] = @UpdateUser, [UpdateComment] = @UpdateComment, [CountryId] = @CountryId"
