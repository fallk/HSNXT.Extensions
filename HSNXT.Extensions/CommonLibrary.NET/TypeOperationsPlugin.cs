...
namespace HSNXT.ComLib.Lang.Plugins
{
    ...
    ***************************************************************************/
    ...
    {
        private readonly IDictionary<string, string> _functionToTypeMap;
        ...
        public TypeOperationsPlugin()
        {
            ...
            var types = new[] {"number", "bool", "date", "time", "string"};
    ...
    public class TypeOperationsExpr : Expr
    {
        ...
        private readonly bool _isConversion;
        private readonly bool _isConversionCheck;
        private readonly string _destinationType;
        private static readonly int CONVERT_MODE_DIRECT = 0;
        private static readonly int CONVERT_MODE_TOSTRING = 1;
        private static readonly int CONVERT_MODE_LAMBDA = 2;
        private static readonly int CONVERT_MODE_NA = 3;


        private static readonly Dictionary<string, ConvertSpec> _conversionLookup =
            new Dictionary<string, ConvertSpec>();

        private static readonly List<ConvertSpec> _conversionSpecs = new List<ConvertSpec>
        {
            ...
            new ConvertSpec("string", "bool", true, false, CONVERT_MODE_LAMBDA, "",
                ConversionHelper.Convert_String_To_Bool, null),
            new ConvertSpec("string", "number", true, false, CONVERT_MODE_LAMBDA, "",
                ConversionHelper.Convert_String_To_Number, null),
            new ConvertSpec("string", "date", true, false, CONVERT_MODE_LAMBDA, "",
                ConversionHelper.Convert_String_To_Date, null),
            new ConvertSpec("string", "time", true, false, CONVERT_MODE_LAMBDA, "",
                ConversionHelper.Convert_String_To_Time, null),
            ...
            new ConvertSpec("bool", "number", true, false, CONVERT_MODE_LAMBDA, "",
                ConversionHelper.Convert_Bool_To_Number, null),
            ...
            new ConvertSpec("number", "bool", true, false, CONVERT_MODE_LAMBDA, "",
                ConversionHelper.Convert_Number_To_Bool, null),
            ...
            new ConvertSpec("date", "string", true, false, CONVERT_MODE_LAMBDA, "",
                ConversionHelper.Convert_Date_To_String, null),
            ...
            new ConvertSpec("date", "time", true, false, CONVERT_MODE_LAMBDA, "", ConversionHelper.Convert_Date_To_Time,
                null),

            new ConvertSpec("time", "string", true, false, CONVERT_MODE_LAMBDA, "",
                ConversionHelper.Convert_Time_To_String, null),
            ...
            new ConvertSpec("time", "date", true, false, CONVERT_MODE_LAMBDA, "", ConversionHelper.Convert_Time_To_Date,
                null),
        ...
        private object CheckExplicitType()
        {
            ...
            else if (_destinationType == "number")
                result = lobj.Type == LTypes.Number;
            else if (_destinationType == "bool")
                result = lobj.Type == LTypes.Bool;
            else if (_destinationType == "date")
                result = lobj.Type == LTypes.Date;
            else if (_destinationType == "time")
                result = lobj.Type == LTypes.Time;
            else if (_destinationType == "list")
                result = lobj.Type == LTypes.Array;
            else if (_destinationType == "map")
                result = lobj.Type == LTypes.Map;
        ...
        private object DoConvertValue(string destinationType, object val, bool handleError)
        {
            ...
            if (spec.ConvertMode == CONVERT_MODE_LAMBDA)
            {
                ...
                else
                {
                    ...
                    {
                        throw BuildRunTimeException("Unable to convert : " + val + " to " + destinationType);
                    }
                }
            }
