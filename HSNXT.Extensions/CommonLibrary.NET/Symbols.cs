...
namespace HSNXT.ComLib.Lang.Core
{
    ...
    public class SymbolsBase : ISymbols
    {
        ...
        /// </summary>
        public virtual ISymbols ParentScope
        {
            get => _parent;
            set => _parent = value;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public virtual IDictionary<string, Symbol> Symbols => _symbols;
        ...
        public virtual void DefineConstant(string name, LType type, object value)
        {
            ...
            var symbol = new SymbolConstant
            {
                Name = name,
                Category = SymbolCategory.Const,
                DataType = LTypes.Object,
                Value = value
            };
            this.Define(symbol);
        }
    ...
    {
        private readonly SymbolsGlobal _global;
        ...
        /// </summary>
        public SymbolsGlobal Global => _global;


        /// <summary>
        /// The symbol table at the current scope
        /// </summary>
        public ISymbols Current => _current;
