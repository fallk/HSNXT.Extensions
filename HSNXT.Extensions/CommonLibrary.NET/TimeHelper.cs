...
namespace HSNXT.ComLib
{
    ...
    public class TimeParseResult
    {
        ...
        public DateTime StartTimeAsDate
        {
            get
            {
                ...
                return new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, Start.Hours, Start.Minutes,
                    Start.Seconds);
            }
        }
        ...
        public DateTime EndTimeAsDate
        {
            get
            {
                ...
                return new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, End.Hours, End.Minutes,
                    End.Seconds);
            }
        }
    }
    ...
    public class TimeParserConstants
    {
        ...
        /// </summary>
        public const string ErrorStartEndTimeSepartorNotPresent =
            "Start and end time separator not present, use '-' or 'to'";
    ...
    public class TimeHelper
    {
        ...
        public static TimeParseResult ParseStartEndTimes(string starts, string ends, bool checkEndTime)
        {
            ...
            if (string.IsNullOrEmpty(starts))
                return new TimeParseResult(false, TimeParserConstants.ErrorStartTimeNotProvided, TimeSpan.MinValue,
                    TimeSpan.MaxValue);

            if (checkEndTime && string.IsNullOrEmpty(ends))
                return new TimeParseResult(false, TimeParserConstants.ErrorEndTimeNotProvided, TimeSpan.MinValue,
                    TimeSpan.MaxValue);
        ...
        public static BoolMessageItem<TimeSpan> Parse(string strTime)
        {
            ...
            if (!match.Success)
                return new BoolMessageItem<TimeSpan>(TimeSpan.MinValue, false,
                    "Time : " + strTime + " is not a valid time.");
