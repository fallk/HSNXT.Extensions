    ...
    ***************************************************************************/
    ...
    public class PrintPlugin : LineReaderPlugin
    {
        ...
        public override bool CanHandle(Token current)
        {
            ...
            if (nextToken.Token == Core.Tokens.LeftParenthesis || nextToken.Token.Text == "\"")
                return false;
            return true;
        }
        ...
        public override Token[] Parse()
        {
            ...
            var resultTokens = ParseLine(includeNewLine);
    ...
    public class PrintExpressionPlugin : ExprPlugin
    {
        ...
        public PrintExpressionPlugin()
        {
            ...
            _startTokens = new[] {"print", "println"};
        }
