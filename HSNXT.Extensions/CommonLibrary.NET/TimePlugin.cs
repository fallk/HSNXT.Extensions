...
namespace HSNXT.ComLib.Lang.Plugins
{
    ...
    ***************************************************************************/
    ...
    {
        private static readonly Dictionary<string, TimeSpan> _aliases;
        ...
        {
            this.StartTokens = new[] {"$NumberToken", "Noon", "noon", "midnight", "Midnight"};
        }
        ...
        /// </summary>
        public override string Grammar =>
            "( ( noon | Noon | midnight | Midnight ) | ( <number> ( ':' <number> ){1,2} ( am | pm ) ) ";
    ...
    ***************************************************************************/
    ...
    public class TimePlugin : LexPlugin
    {
        ...
        public TimePlugin()
        {
            _tokens = new[] {"$NumberToken", "Noon", "noon", "midnight", "Midnight"};
        }
