    ...
    public class EnvUtils
    {
        ...
        public static List<EnvItem> Parse(string selectedEnv, out string firstEnv)
        {
            ...
            if (string.IsNullOrEmpty(selectedEnv))
                throw new ArgumentException("Must provide the selected environment.");
        ...
        /// <returns></returns>
        public static string CollectEnvironmentProps(List<EnvItem> inheritedChainedEnvs, string delimeter,
            Func<EnvItem, string> propGetter)
        {
