...
namespace HSNXT.ComLib.Models
{
    ...
    public class Model
    {
        ...
        public Model Required
        {
            get
            {
                this.Properties[this.Properties.Count - 1].IsRequired = true;
                return this;
            }
        }
        ...
        public Model Key
        {
            get
            {
                this.Properties[this.Properties.Count - 1].IsKey = true;
                return this;
            }
        }
        ...
        public Model Persist
        {
            get
            {
                this.Properties[this.Properties.Count - 1].CreateColumn = true;
                return this;
            }
        }
        ...
        public Model Code
        {
            get
            {
                this.Properties[this.Properties.Count - 1].CreateCode = true;
                return this;
            }
        }
        ...
        public Model NotPersisted
        {
            get
            {
                this.Properties[this.Properties.Count - 1].CreateColumn = false;
                return this;
            }
        }
        ...
        public Model NoCode
        {
            get
            {
                this.Properties[this.Properties.Count - 1].CreateCode = false;
                return this;
            }
        }
        ...
        public Model GetterOnly
        {
            get
            {
                this.Properties[this.Properties.Count - 1].IsGetterOnly = true;
                return this;
            }
        }
        ...
        {
            this.ExcludeFiles =
                "ActiveRecord.cs,Service.cs,Validator.cs,Repository.cs,Settings.cs,Feeds.cs,ImportExport.cs,Serializer.cs";
