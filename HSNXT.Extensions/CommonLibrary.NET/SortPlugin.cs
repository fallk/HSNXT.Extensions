...
namespace HSNXT.ComLib.Lang.Plugins
{
    ...
    ***************************************************************************/
    ...
    public class SortPlugin : ExprPlugin
    {
        ...
        public SortPlugin()
        {
            this.StartTokens = new[] {"sort", "Sort"};
        ...
        /// </summary>
        public override string Grammar => "sort <expression> ( in <expression> )? by <expression> ( asc | desc )?";
        ...
        public override Expr Parse()
        {
            ...
            if (string.Compare(ascDesc, "asc", StringComparison.InvariantCultureIgnoreCase) == 0 ||
                string.Compare(ascDesc, "desc", StringComparison.InvariantCultureIgnoreCase) == 0)
            {
    ...
    public class SortExpr : IndexableExpr
    {
        ...
        public override object Evaluate()
        {
            ...
            items.Sort(delegate(object x, object y)
            {
                ...
                var a = _filter.Evaluate();

                Ctx.Memory.SetValue(_varName, y);
                var b = _filter.Evaluate();
