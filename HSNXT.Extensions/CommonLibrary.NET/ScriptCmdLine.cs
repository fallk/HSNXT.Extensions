    ...
    public class ScriptCmdLine : Script
    {
        ...
        private bool ProcessTokenType(JsLiteArgs args)
        {
            ...
            if (args.TokenType == JsLiteToken.FuncCall)
            {
                ...
                var result = ExecuteCommand(args.Name, args.ParamList, args.ParamMap, args.LineNumber,
                    command => AutoMapper.Map<object>(_currentLineArgs, command, AutoMapperSettings.Default, null));
