...
namespace HSNXT.ComLib.Lang.AST
{
    ...
    public class FunctionExpr : BlockExpr
    {
        ...
        /// Gets the metadata.
        /// </summary>
        public FunctionMetaData Meta => _meta;
        ...
        /// </summary>
        public bool HasArguments => _meta.Arguments != null && _meta.Arguments.Count > 0;
        ...
        private void PushParametersInScope()
        {
            ...
            for (var ndx = 0; ndx < this.Meta.Arguments.Count; ndx++)
            {
