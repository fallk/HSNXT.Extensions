...
namespace HSNXT.ComLib.Entities
{
    ...
    public class RepositoryQueryable : IRepositoryConfigurable, IRepositoryQueryable
    {
        ...
        protected virtual string BuildSqlSelect(IQuery criteria, string cols, string fromTable, string whereFilter,
            string groupByCols, bool useLimit)
        {
            var select = "*";
