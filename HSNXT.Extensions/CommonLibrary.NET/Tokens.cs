...
namespace HSNXT.ComLib.Lang.Core
{
    ...
    public class Token
    {
        ...
        {
            return _kind == TokenKind.Keyword;
        }
        ...
        {
            return _kind == TokenKind.Comment;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public bool IsLiteralAny()
        {
            return _kind >= TokenKind.LiteralString;
        }
        ...
        {
            return _kind >= TokenKind.LiteralNumber;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public bool IsLiteralDate()
        {
            return _kind >= TokenKind.LiteralDate;
        }
