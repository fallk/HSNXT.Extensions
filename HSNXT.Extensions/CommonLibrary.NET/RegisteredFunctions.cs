...
namespace HSNXT.ComLib.Lang.Parsing
{
    ...
    {
        private readonly Dictionary<string, FunctionExpr> _functions;
        private readonly Dictionary<string, string> _lcaseToFormaNameMap;
        ...
        /// <returns></returns>
        public object CallByName(string functionName, List<Expr> paramListExpressions, List<object> paramVals,
            bool resolveParams)
        {
