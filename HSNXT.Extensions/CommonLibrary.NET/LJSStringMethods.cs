...
namespace HSNXT.ComLib.Lang.Types
{
    ...
    public class LJSStringMethods : LTypeMethods
    {
        ...
        public LJSStringMethods()
        {
            ...
            AddMethod("charCodeAt", "CharAt", typeof(string),
                "Returns the Unicode of the character at the specified index");
            AddMethod("concat", "Concat", typeof(string),
                "Joins two or more strings, and returns a copy of the joined strings");
            AddMethod("fromCharCode", "CharAt", typeof(string), "Converts Unicode values to characters");
            AddMethod("indexOf", "IndexOf", typeof(double),
                "Returns the position of the first found occurrence of a specified value in a string");
            AddMethod("lastIndexOf", "LastIndexOf", typeof(double),
                "Returns the position of the last found occurrence of a specified value in a string");
            AddMethod("match", "CharAt", typeof(string),
                "Searches for a match between a regular expression and a string, and returns the matches");
            AddMethod("replace", "Replace", typeof(string),
            ...
            AddMethod("search", "Search", typeof(string),
            ...
            AddMethod("substr", "Substr", typeof(string),
                "Extracts the characters from a string, beginning at a specified start position, and through the specified number of character");
            AddMethod("substring", "Substring", typeof(string),
            ...
            AddArg("charAt", "index", "int", true, "", 0, "0 | 4",
            ...
            AddArg("lastIndexOf", "start", "number", false, "", -1, "0 | 4",
                "The position where to start the search. If omitted, the default value is the length of the string");
            AddArg("replace", "searchvalue", "string", true, "", "", "abc",
            ...
            AddArg("search", "searchvalue", "string", true, "", "", "abc",
                "The value, or regular expression, to search for.");
            AddArg("substr", "start", "int", true, "", 0, "0 | 4",
                "The postition where to start the extraction. First character is at index 0");
            AddArg("substr", "length", "int", false, "", "", "5 | 10",
                "The number of characters to extract. If omitted, it extracts the rest of the string");
            AddArg("substring", "from", "int", true, "", 0, "0 | 4",
                "The index where to start the extraction. First character is at index 0");
            AddArg("substring", "to", "int", false, "", "", "5 | 10",
                "The index where to stop the extraction. If omitted, it extracts the rest of the string");
        }
