...
namespace HSNXT.ComLib.Lang.Types
{
    ...
    public class Units
    {
        ...
        private readonly Dictionary<string, UnitGroup> _groups;
        private readonly Dictionary<string, UnitSubGroup> _subGroups;
        private readonly Dictionary<string, string> _subGroupsToGroupMap;
