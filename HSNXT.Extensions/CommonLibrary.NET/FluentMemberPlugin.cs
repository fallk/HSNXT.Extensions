...
namespace HSNXT.ComLib.Lang.Plugins
{
    ...
    ***************************************************************************/
    ...
    public class FluentMemberPlugin : ExprPlugin
    {
        ...
        private static readonly Dictionary<string, List<List<FluentPart>>> _matches =
            new Dictionary<string, List<List<FluentPart>>>();
        ...
        ***************************************************************************************** */
        ...
        public override Expr Parse()
        {
            ...
            if (mexp != null)
            {
                ...
                if (helper.IsClassMethod(matchResult.Item1, memExp.MemberName) ||
                    helper.IsInstanceMethod(matchResult.Item1, memExp.MemberName))
                {
        ...
        private Tuple<bool, Expr> IsMatch(FluentPluginHelper helper, Type type, Token klass, Token instance, Token prop,
            Token method)
        {
