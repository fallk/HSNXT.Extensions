    ...
    public class ReflectionUtils
    {
        ...
        public static IList<PropertyInfo> GetWritableProperties(object obj, StringDictionary propsToExclude)
        {
            var props = GetWritableProperties(obj.GetType(),
                ...
                {
                    var okToAdd = propsToExclude == null
                        ? property.CanWrite
                        : (property.CanWrite && !propsToExclude.ContainsKey(property.Name));
                    return okToAdd;
                });
            return props;
        }
        ...
        public static IDictionary<string, PropertyInfo> GetPropertiesAsMap(Type type, BindingFlags flags,
        ...
        public static PropertyInfo GetProperty(Type type, string propertyName)
        {
            var props = GetProperties(type,
                delegate(PropertyInfo property) { return property.Name == propertyName; });
            return props[0];
        }
