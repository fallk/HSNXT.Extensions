...
namespace HSNXT.ComLib.Notifications
{
    ...
    public class NotificationDef
    {
        ...
        public NotificationDef(string name, string fulllocation, string fileName, bool isAssemblyEmbedded,
            string assemblyName, bool isXsl)
        {
            Name = name;
    ...
    public class NotificationDefinitions
    {
        ...
        {
            _defs["WelcomeNewUser"] = new NotificationDef("WelcomeNewUser", "Notifications.Templates.welcome.html",
                "welcome.html", true, "CommonLibrary", false);
            _defs["ForgotPassword"] = new NotificationDef("ForgotPassword",
                "Notifications.Templates.password_reminder.html", "password_reminder.html", true, "CommonLibrary",
                false);
            _defs["SendWebSitePost"] = new NotificationDef("SendWebSitePost",
                "Notifications.Templates.sendtofriend_post.html", "sendtofriend_post.html", true, "CommonLibrary",
                false);
            _defs["SendWebSite"] = new NotificationDef("SendWebSite", "Notifications.Templates.sendtofriend_site.html",
                "sendtofriend_site.html", true, "CommonLibrary", false);
            _defs["SubmitFeedback"] = new NotificationDef("SubmitFeedback", "Notifications.Templates.feedback.html",
                "feedback.html", true, "CommonLibrary", false);
        }
