...
namespace HSNXT.ComLib.Data
{
    ...
    public static class DbExecute
    {
        ...
        /// <returns></returns>
        public static T Execute<T>(this IDBHelper dbHelper, string commandText, CommandType commandType,
            DbParameter[] dbParameters, string outputParamName)
        {
        ...
        /// <returns></returns>
        public static int Execute(this IDBHelper dbHelper, string commandText, CommandType commandType,
        ...
        /// <returns></returns>
        public static IDictionary<string, object> Execute(this IDBHelper dbHelper, string commandText,
