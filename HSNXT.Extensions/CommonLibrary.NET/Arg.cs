...
namespace HSNXT.ComLib.Arguments
{
    ...
    public class ArgAttribute : Attribute
    {
        ...
        public ArgAttribute(string name, string alias, string description, Type dataType, bool isRequired,
            object defaultValue = null, string example = "", string exampleMultiple = "",
            bool interpret = false, bool isCaseSensitive = false, bool onlyForDevelopment = false)
        {
            Init(name, description, dataType, isRequired, isCaseSensitive, defaultValue, onlyForDevelopment, example,
                exampleMultiple);
            Interpret = interpret;
            Alias = alias;
        }
        ...
        /// <param name="isCaseSensitive">Whether or not the argument is case sensitive</param>
        /// <param name="onlyForDevelopment">Whether or not the argument is for development purposes only</param>
        public ArgAttribute(int indexPosition, string description, Type dataType, bool isRequired,
            object defaultValue = null, string example = "", string exampleMultiple = "",
            bool interpret = false, bool isCaseSensitive = false, bool onlyForDevelopment = false)
        {
        ...
        public void Init(string name, string description, Type dataType, bool isRequired, bool isCaseSensitive,
            object defaultValue,
