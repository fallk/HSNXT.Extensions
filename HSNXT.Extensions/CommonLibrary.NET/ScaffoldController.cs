...
namespace HSNXT.ComLib.Scaffolding
{
    ...
    public class ScaffoldController
    {
        ...
        {
            context.PropValues =
                _scaffoldUtils.GetValuesFromUI(context.EntityName, context.ParentControlId, _propertiesToExclude);
        ...
        private void DisplayEntity(string entityName, string clientId, bool loadEntityValues, object entityObject,
            StringDictionary propertiesToExclude)
        {
            var table = _scaffoldUtils.BuildEntityUITable(entityName, clientId, loadEntityValues, entityObject,
                propertiesToExclude);
