...
namespace HSNXT.ComLib.Cryptography.DES
{
    ...
    public class TripleDES
    {
        ...
        {
            Debug.WriteLine("Encrypt [" + data.ByteArrayToHex() + "] using [" + key.ByteArrayToHex() + "] = [" +
                            DESOperation(key, data, true).ByteArrayToHex() + "].");
        ...
        {
            Debug.WriteLine("Decrypt [" + data.ByteArrayToHex() + "] using [" + key.ByteArrayToHex() + "] = [" +
                            DESOperation(key, data, true).ByteArrayToHex() + "].");
