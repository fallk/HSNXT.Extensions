...
namespace HSNXT.Utils
{
    ...
    public static class ExtendedBitConverter
    {
        ...
        public static void ToBytes(this short value, byte[] buffer, int offset = 0, bool? asLittleEndian = null)
        {
            ...
            if (asLittleEndian ?? IsLittleEndian)
            {
        ...
        {
            return asLittleEndian ?? IsLittleEndian;
        }
        ...
        public static long ToInt64(this byte[] bytes, int offset = 0, bool? asLittleEndian = null)
        {
            ...
            return ale
                ? bytes[offset] | (long) bytes[offset + 1] << 8 | (long) bytes[offset + 2] << 16 |
                  (long) bytes[offset + 3] << 24 | (long) bytes[offset + 4] << 32 |
                  (long) bytes[offset + 5] << 40 | (long) bytes[offset + 6] << 48 | (long) bytes[offset + 7] << 56
                : (long) bytes[offset] << 56 | (long) bytes[offset + 1] << 48 | (long) bytes[offset + 2] << 40 |
                  (long) bytes[offset + 3] << 32 |
                  (long) bytes[offset + 4] << 24 | (long) bytes[offset + 5] << 16 | (long) bytes[offset + 6] << 8 |
                  bytes[offset + 7];
        }
        ...
        public static Int128 ToInt128(this byte[] bytes, int offset = 0, bool? asLittleEndian = null)
        {
            ...
            return new Int128(bytes.ToUInt64(ale ? offset + 8 : offset, ale),
                bytes.ToUInt64(ale ? offset : offset + 8, ale));
        }
