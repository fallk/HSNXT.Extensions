...
namespace HSNXT
{
    ...
    public struct Int256 : IComparable<Int256>, IComparable, IEquatable<Int256>, IFormattable
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)] [FieldOffset(32)]
        private ulong _a;
        ...
        {
            var int256 = value.ToByteArray().ToInt256();
            _a = int256.A;
            _b = int256.B;
            _c = int256.C;
            _d = int256.D;
        ...
        public static bool TryParse(string value, NumberStyles style, IFormatProvider provider, out Int256 result)
        {
            ...
            return (style & NumberStyles.AllowHexSpecifier) == NumberStyles.AllowHexSpecifier
                ? TryParseHex(value, out result)
                : TryParseNum(value, out result);
        }
        ...
        {
            if (TryConvert(conversionType, provider, asLittleEndian, out var value))
            {
                return value;
            }
        ...
        public static int Compare(Int256 left, object right)
        {
            ...
            {
                case Int256 int256:
                    return Compare(left, int256);
                case bool b:
                    return Compare(left, new Int256(b));
                case byte b1:
                    return Compare(left, new Int256(b1));
                case char c:
                    return Compare(left, new Int256(c));
                case decimal @decimal:
                    return Compare(left, new Int256(@decimal));
                case double d:
                    return Compare(left, new Int256(d));
                case short s:
                    return Compare(left, new Int256(s));
                case int i:
                    return Compare(left, new Int256(i));
                case long l:
                    return Compare(left, new Int256(l));
                case sbyte @sbyte:
                    return Compare(left, new Int256(@sbyte));
                case float f:
                    return Compare(left, new Int256(f));
                case ushort @ushort:
                    return Compare(left, new Int256(@ushort));
                case uint u:
                    return Compare(left, new Int256(u));
                case ulong @ulong:
                    return Compare(left, new Int256(@ulong));
                case byte[] bytes when bytes.Length == 32:
                    // TODO: ensure endian.
                    return Compare(left, bytes.ToInt256());
                case Guid guid:
                    return Compare(left, new Int256(guid));
            }
        ...
        public static int Compare(Int256 left, Int256 right)
        {
            ...
            return left._c != right._c ? left._c.CompareTo(right._c) : left._d.CompareTo(right._d);
        }
        ...
        public static Int256 DivRem(Int256 dividend, Int256 divisor, out Int256 remainder)
        {
            ...
            MathUtils.DivModUnsigned(dividend.ToUIn32Array(), divisor.ToUIn32Array(), out var quotient, out var rem);
        ...
        public static explicit operator decimal(Int256 value)
        {
            ...
            return new decimal((int) (value._d & 0xFFFFFFFF), (int) (value._d >> 32), (int) (value._c & 0xFFFFFFFF),
                value.Sign < 0, 0);
        }
