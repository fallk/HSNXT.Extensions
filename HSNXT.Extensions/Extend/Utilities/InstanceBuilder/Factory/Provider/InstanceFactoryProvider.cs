...
namespace HSNXT
{
    ...
    internal static class InstanceFactoryProvider
    {
        ...
        {
            yield return
                new ExpressionInstanceFactory(x => Extensions.GetRandomInt16(), "Int16 Factory",
                        "Factory for Int16 values.")
            ...
            yield return
                new ExpressionInstanceFactory(x => Extensions.GetRandomInt32(), "Int32 Factory",
                        "Factory for Int32 values.")
            ...
            yield return
                new ExpressionInstanceFactory(x => Extensions.GetRandomInt64(), "Int64 Factory",
                        "Factory for Int64 values.")
            ...
            yield return
                new ExpressionInstanceFactory(x => Extensions.GetRandomDouble(), "Double Factory",
            ...
            yield return
                new ExpressionInstanceFactory(x => Extensions.GetRandomChar(), "Char Factory",
                        "Factory for Char values.")
            ...
            yield return
                new ExpressionInstanceFactory(x => Extensions.GetRandomString(), "String Factory",
            ...
            yield return
                new ExpressionInstanceFactory(x => Extensions.GetRandomBoolean(), "Boolean Factory",
            ...
            yield return
                new ExpressionInstanceFactory(x => Extensions.GetRandomDateTime(), "DateTime Factory",
