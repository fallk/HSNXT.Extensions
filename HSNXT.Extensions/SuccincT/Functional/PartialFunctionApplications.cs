...
namespace HSNXT
{
    public partial class Extensions
    {
        ...
        /// </summary>
        public static Func<T2, TResult> Apply<T1, T2, TResult>(this Func<T1, T2, TResult>
            functionToApply, T1 p1) =>
        ...
        public static Func<T2, T3, TResult>
            Apply<T1, T2, T3, TResult>(this Func<T1, T2, T3, TResult> functionToApply, T1 p1) =>
        ...
        public static Func<T3, TResult>
            Apply<T1, T2, T3, TResult>(this Func<T1, T2, T3, TResult> functionToApply,
                T1 p1,
                T2 p2) =>
        ...
        public static Func<T2, T3, T4, TResult>
            Apply<T1, T2, T3, T4, TResult>(this Func<T1, T2, T3, T4, TResult> functionToApply,
                T1 p1) =>
