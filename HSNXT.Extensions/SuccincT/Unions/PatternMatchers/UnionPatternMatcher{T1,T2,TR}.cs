...
namespace HSNXT.SuccincT.Unions.PatternMatchers
{
        ...
        IUnionActionPatternMatcherAfterElse
    {
        ...
        IUnionActionPatternCaseHandler<IUnionActionPatternMatcher<T1, T2>, T1> IUnionActionPatternMatcher<T1, T2>.
            Case1()
            =>
                new UnionPatternCaseHandler<IUnionActionPatternMatcher<T1, T2>, T1, Unit>(_selector.RecordAction, this);

        IUnionActionPatternCaseHandler<IUnionActionPatternMatcher<T1, T2>, T2> IUnionActionPatternMatcher<T1, T2>.
            Case2() =>
