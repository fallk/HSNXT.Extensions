...
namespace HSNXT
{
    public static partial class Extensions
    {
        ...
        {
            return (new SortedDictionary<TKey, TValue>(dictionary)).OrderBy(kvp => kvp.Value)
        ...
        public static TValue GetOrThrow<TKey, TValue>(this IDictionary<TKey, TValue> source, TKey key,
            Exception exception)
        {
            TValue value;
