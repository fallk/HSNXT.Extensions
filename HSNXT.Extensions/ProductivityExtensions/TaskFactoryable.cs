...
namespace HSNXT
{
    public static partial class Extensions
    {
        ...
        /// </returns>
        public static Task FromAsync<TArg1>(this TaskFactory taskFactory,
            Func<TArg1, AsyncCallback, object, IAsyncResult> beginMethod, Action<IAsyncResult> endMethod, TArg1 arg1)
        {
        ...
        /// The created <see cref="T:System.Threading.Tasks.Task"/> that represents the asynchronous operation.
        /// </returns>
        public static Task FromAsync<TArg1, TArg2>(this TaskFactory taskFactory,
            Func<TArg1, TArg2, AsyncCallback, object, IAsyncResult> beginMethod, Action<IAsyncResult> endMethod,
        ...
        public static Task FromAsync<TArg1, TArg2>(this TaskFactory taskFactory,
            Func<TArg1, TArg2, AsyncCallback, object, IAsyncResult> beginMethod, Action<IAsyncResult> endMethod,
            TArg1 arg1, TArg2 arg2, TaskCreationOptions creationOptions)
        {
            if (taskFactory == null) throw new ArgumentNullException(nameof(taskFactory));
        ...
        /// The created <see cref="T:System.Threading.Tasks.Task"/> that represents the asynchronous operation.
        /// </returns>
        public static Task FromAsync<TArg1, TArg2, TArg3>(this TaskFactory taskFactory,
            Func<TArg1, TArg2, TArg3, AsyncCallback, object, IAsyncResult> beginMethod, Action<IAsyncResult> endMethod,
        ...
        public static Task FromAsync<TArg1, TArg2, TArg3>(this TaskFactory taskFactory,
            Func<TArg1, TArg2, TArg3, AsyncCallback, object, IAsyncResult> beginMethod, Action<IAsyncResult> endMethod,
            TArg1 arg1, TArg2 arg2, TArg3 arg3, TaskCreationOptions creationOptions)
        {
            if (taskFactory == null) throw new ArgumentNullException(nameof(taskFactory));
