...
{
    public class UnionOf4Converter : JsonConverter
    {
            ...
            NJsonSerializer serializer)
        {
            ...
            var type4 = objectType.GenericTypeArguments[3];
            var rawUnionType = typeof(Union<,,,>);
            var unionType = rawUnionType.MakeGenericType(type1, type2, type3, type4);
