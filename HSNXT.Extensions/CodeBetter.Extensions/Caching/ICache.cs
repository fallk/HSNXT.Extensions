...
namespace HSNXT
{
    ...
    public interface ICache
    {
        ...
        T Fetch<T>(string key, Func<T> callIfGetReturnsNull, CacheDependency dependencies, DateTime absoluteExpiration,
        ...
        T Fetch<T>(string key, Action<T> callIfGetReturnsValue, Func<T> callIfGetReturnsNull,
        ...
        void Insert(string key, object data, CacheDependency dependencies, DateTime absoluteExpiration,
            TimeSpan slidingExpiration, params object[] keyArgs);
