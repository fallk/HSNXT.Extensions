...
namespace HSNXT
{
    ...
    public class InMemoryCache : ICache
    {
        ...
        public T Fetch<T>(string key, Func<T> callIfGetReturnsNull, DateTime absoluteExpiration,
        ...
        public T Fetch<T>(string key, Func<T> callIfGetReturnsNull, CacheDependency dependencies,
            params object[] keyArgs)
        {
        ...
        {
            return HttpRuntime.Cache.Fetch(key, callIfGetReturnsNull, dependencies, absoluteExpiration,
                slidingExpiration, keyArgs);
        }
        ...
        {
            return HttpRuntime.Cache.Fetch(key, callIfGetReturnsNull, dependencies, absoluteExpiration,
                slidingExpiration, priority, onRemoveCallback, keyArgs);
        }

        public T Fetch<T>(string key, Action<T> callIfGetReturnsValue, Func<T> callIfGetReturnsNull,
            params object[] keyArgs)
        {
        ...
        {
            return HttpRuntime.Cache.Fetch(key, callIfGetReturnsValue, callIfGetReturnsNull, absoluteExpiration,
                keyArgs);
        }
        ...
        {
            return HttpRuntime.Cache.Fetch(key, callIfGetReturnsValue, callIfGetReturnsNull, slidingExpiration,
                keyArgs);
        }
        ...
        public T Fetch<T>(string key, Action<T> callIfGetReturnsValue, Func<T> callIfGetReturnsNull,
            ...
            params object[] keyArgs)
        {
            return HttpRuntime.Cache.Fetch(key, callIfGetReturnsValue, callIfGetReturnsNull, dependencies,
                absoluteExpiration, slidingExpiration, keyArgs);
        }
        ...
        {
            return HttpRuntime.Cache.Fetch(key, callIfGetReturnsValue, callIfGetReturnsNull, dependencies,
                absoluteExpiration, slidingExpiration, priority, onRemoveCallback, keyArgs);
        }
        ...
        public void Insert(string key, object data, CacheDependency dependencies, DateTime absoluteExpiration,
            TimeSpan slidingExpiration, params object[] keyArgs)
        {
        ...
        public void Insert(string key, object data, CacheDependency dependencies, DateTime absoluteExpiration,
            ...
            params object[] keyArgs)
        {
            HttpRuntime.Cache.Insert(key, data, dependencies, absoluteExpiration, slidingExpiration, priority,
                onRemoveCallback, keyArgs);
        }
