...
namespace erichexter.Should.Facts.Core
{
    public class InRangeTests
    {
        public class RangeForDoubles
        {
            ...
            {
                Should.Core.Assertions.Assert.Throws<InRangeException>(() => Should.Core.Assertions.Assert.InRange(1.50, .75, 1.25));
            }
        ...
        public class RangeForInts
        {
            ...
            {
                Should.Core.Assertions.Assert.Throws<InRangeException>(() => Should.Core.Assertions.Assert.InRange(0, 1, 2));
            }

            [Fact]
            public void IntNotWithinRangeWithZeroMinimum()
            {
                Should.Core.Assertions.Assert.Throws<InRangeException>(() => Should.Core.Assertions.Assert.InRange(2, 0, 1));
            }
        ...
        public class RangeForStrings
        {
            ...
            {
                Should.Core.Assertions.Assert.Throws<InRangeException>(() => Should.Core.Assertions.Assert.InRange("adam", "bob", "scott"));
            }
        ...
        public class RangeForWithNull
        {
            ...
            {
                Should.Core.Assertions.Assert.Throws<InRangeException>(() => Should.Core.Assertions.Assert.InRange(null, "a", "z"));
            }

            [Fact]
            public void When_comparing_something_in_range_high_bounded_by_a_null_Should_throw_InRangeException()
            {
                Should.Core.Assertions.Assert.Throws<InRangeException>(() => Should.Core.Assertions.Assert.InRange("m", null, "z"));
            }
        ...
        public class RangeForComparables
        {
            ...
            {
                Should.Core.Assertions.Assert.InRange(new ComparableObject(1), new ComparableObject(0), new ComparableObject(2));
            }

            [Fact]
            public void When_comparing_comparable_to_derived_comparables_within_range_Should_pass()
            {
                Should.Core.Assertions.Assert.InRange(new ComparableObject(1), new DerivedComparableObject(0), new DerivedComparableObject(2));
            }

            [Fact]
            public void When_comparing_derived_comparable_to_comparables_within_range_Should_pass()
            {
                Should.Core.Assertions.Assert.InRange(new DerivedComparableObject(1), new  ComparableObject(0), new ComparableObject(2));
            }

            [Fact]
            public void When_comparing_generic_comparables_within_range_Should_pass()
            {
                Should.Core.Assertions.Assert.InRange(new GenericComparableObject(1), new GenericComparableObject(0), new GenericComparableObject(2));
            }

            [Fact]
            public void When_comparing_generic_comparable_to_derived_generic_comparables_within_range_Should_pass()
            {
                Should.Core.Assertions.Assert.InRange(new GenericComparableObject(1), new DerivedGenericComparableObject(0), new DerivedGenericComparableObject(2));
            }

            [Fact]
            public void When_comparing_derived_generic_comparable_to_generic_comparables_within_range_Should_pass()
            {
                Should.Core.Assertions.Assert.InRange(new DerivedGenericComparableObject(1), new GenericComparableObject(0), new GenericComparableObject(2));
            }

            [Fact]
            public void When_comparing_comparables_outside_range_Should_throw_InRangeException()
            {
                 Should.Core.Assertions.Assert.Throws<InRangeException>(() => Should.Core.Assertions.Assert.InRange(new ComparableObject(3), new ComparableObject(0), new ComparableObject(2)));
            }

            [Fact]
            public void When_comparing_generic_comparables_outside_range_Should_throw_InRangeException()
            {
                Should.Core.Assertions.Assert.Throws<InRangeException>(() => Should.Core.Assertions.Assert.InRange(new GenericComparableObject(3), new GenericComparableObject(0), new GenericComparableObject(2)));
            }

            [Fact]
            public void When_comparing_comparable_derived_comparable_outside_range_Should_throw_InRangeException()
            {
                Should.Core.Assertions.Assert.Throws<InRangeException>(() => Should.Core.Assertions.Assert.InRange(new ComparableObject(3), new DerivedComparableObject(0), new DerivedComparableObject(2)));
            }

            [Fact]
            public void When_comparing_generic_comparable_derived_generic_comparable_outside_range_Should_throw_InRangeException()
            {
                Should.Core.Assertions.Assert.Throws<InRangeException>(() => Should.Core.Assertions.Assert.InRange(new GenericComparableObject(3), new DerivedGenericComparableObject(0), new DerivedGenericComparableObject(2)));
            }
