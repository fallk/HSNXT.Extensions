...
namespace Tests
{
	...
	public class when_comparing_versions
	{
		...
		{
			Assert.IsTrue(Extensions.WindowsVistaVersion.IsBetween(Extensions.Windows95Version, Extensions.Windows8Version));
		}

		[Test]
		public void then_version_not_between_others_fails()
		{
			Assert.IsFalse(Extensions.Windows95Version.IsBetween(Extensions.WindowsVistaVersion, Extensions.Windows8Version));
		}
	}
}