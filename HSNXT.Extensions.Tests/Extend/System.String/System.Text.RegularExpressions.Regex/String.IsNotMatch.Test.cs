...
namespace Extend.Testing
{
    public partial class StringExTest
    {
        ...
        public void IsNotMatchTest1NullCheck()
        {
            ...
            Action test = () => Extensions.IsNotMatch(null, "", RegexOptions.CultureInvariant);
        ...
        public void IsNotMatchTest2NullCheck()
        {
            // ReSharper disable once AssignNullToNotNullAttribute
            // ReSharper disable once ReturnValueOfPureMethodIsNotUsed
            Action test = () => Extensions.IsNotMatch(null, "", RegexOptions.CultureInvariant, 10.ToSeconds());
        ...
        {
            const String emaiLpattern = @"^([\w\.\-]+)@([\w\-]+)((\.(\w){2,3})+)$";
            var validEmail = Extensions.GetRandomStrings(10000)
        ...
        public void IsNotMatchTestNullCheck()
        {
            // ReSharper disable once AssignNullToNotNullAttribute
            // ReSharper disable once ReturnValueOfPureMethodIsNotUsed
            Action test = () => Extensions.IsNotMatch(null, "");
