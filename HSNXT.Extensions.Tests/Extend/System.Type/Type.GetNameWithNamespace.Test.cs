...
namespace Extend.Testing
{
    public partial class TypeExTest
    {
        ...
        public void GetNameWithNamespaceGenericNestedTest()
        {
            ...
            actual.Should()
                .Be(
                    "HSNXT.TreeNode`1[[HSNXT.IIndexedItem`1[[Extend.Testing.TypeExTest+TestClass, HSNXT.Extensions.Tests]], HSNXT.Extensions]], HSNXT.Extensions");
        ...
        public void GetNameWithNamespaceGenericNestedTest1()
        {
            ...
            actual.Should()
                .Be(
                    "HSNXT.TreeNode`1[[HSNXT.TreeNode`1[[HSNXT.IIndexedItem`1[[Extend.Testing.TypeExTest+TestClass, HSNXT.Extensions.Tests]], HSNXT.Extensions]], HSNXT.Extensions]], HSNXT.Extensions");
        ...
        public void GetNameWithNamespaceGenericNestedTest2()
        {
            ...
            actual.Should()
                .Be(
                    "HSNXT.TreeNode`1[[HSNXT.TreeNode`1[[Extend.Testing.TypeExTest, HSNXT.Extensions.Tests]], HSNXT.Extensions]], HSNXT.Extensions");
        ...
        public void GetNameWithNamespaceGenericNestedTest3()
        {
            ...
            actual.Should()
                .Be(
                    "HSNXT.TreeNode`1[[HSNXT.TreeNode`1[[Extend.Testing.TypeExTest+TestClass, HSNXT.Extensions.Tests]], HSNXT.Extensions]], HSNXT.Extensions");
        ...
        {
            var actual =
                typeof(TreeNode<TreeNode<TestClassGeneric2<TestClassGeneric2<TestClass, TestClass>, TestClass>>>)
        ...
        public void GetNameWithNamespaceGenericTest()
        {
            ...
            actual.Should()
                .Be(
                    "HSNXT.TreeNode`1[[Extend.Testing.TypeExTest+TestClass, HSNXT.Extensions.Tests]], HSNXT.Extensions");
        ...
        public void GetNameWithNamespacePrivateClassGenericTest()
        {
            ...
            actual.Should()
                .Be(
                    "Extend.Testing.TypeExTest+TestClassGeneric`1[[Extend.Testing.TypeExTest+TestClass, HSNXT.Extensions.Tests]], HSNXT.Extensions.Tests");
