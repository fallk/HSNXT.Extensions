...
namespace Extend.Testing
{
    public class TypeMemberSelectionRuleTest
    {
        ...
        {
            var target =
                new TypeMemberSelectionRule(typeof(Int32), MemberSelectionMode.Exclude, CompareMode.Is, "X", "Y");
        ...
        {
            var target = new TypeMemberSelectionRule(typeof(Double), MemberSelectionMode.Include, CompareMode.IsNot,
                "1", "2");
        ...
        {
            var target = new TypeMemberSelectionRule(typeof(Char), MemberSelectionMode.Exclude, CompareMode.IsNot, "10",
                "100");
