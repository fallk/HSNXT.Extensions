...
namespace Extend.Testing
{
    public class StringTemplate
    {
        ...
        public void FormatWithObject_ComplexTemplate()
        {
            ...
            actual.Should()
                .Be(
                    "{{123} bla} | Ignore: {Ignore} | MyInt: 1234 001234 1-23-4 | MyString: asdf | MyDouble: 12345.987654 | MyNull: ");
        }
        ...
        {
            Action test = () =>
                "{{[]}}{bar}{foo}}{MyInt:0000}{".FormatWithObject(new {foo = 123.45, bar = "asd", MyInt = 123434});
            test.ShouldThrow<FormatException>();
        }
        ...
        {
            Action test = () =>
                "{{[]}}{bar}{foo}{MyInt:0000}{{}{bar}".FormatWithObject(new
                {
                    foo = 123.45,
                    bar = "asd",
                    MyInt = 123434
        ...
        {
            Action test = () =>
                "{{[]}}{{bar}{foo}}".FormatWithValues(
                    new Dictionary<String, Object> {{"foo", 123.45}, {"bar", "asd"}, {"MyInt", 123434}});
            test.ShouldThrow<FormatException>();
        }
        ...
        {
            Action test = () =>
                "{{[]}}{bar}{foo}}{MyInt:0000}{".FormatWithValues(
                    new Dictionary<String, Object> {{"foo", 123.45}, {"bar", "asd"}, {"MyInt", 123434}});
            test.ShouldThrow<FormatException>();
        }
        ...
        {
            Action test =
                () => "{{[]}}{bar}{foo}{MyInt:0000}{{}{bar}".FormatWithValues(
                    new Dictionary<String, Object> {{"foo", 123.45}, {"bar", "asd"}, {"MyInt", 123434}});
            test.ShouldThrow<FormatException>();
        }
        ...
        {
            var actual =
                "{foo} {foo} {bar}{baz}".FormatWithValues(
                    new Dictionary<String, Object> {{"foo", 123.45}, {"bar", 42}, {"baz", "hello"}});
            actual.Should()
                .Be("123.45 123.45 42hello");
        }
