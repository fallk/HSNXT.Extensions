...
namespace HSNXT.ComLib.Lang.Tests.Common
{
    ...
    public class Klass2
    {
        ...
        // Props
        public static double KPropNumber
        {
            get { return _kprop1; }
            set { _kprop1 = value; }
        }

        public static string KPropString
        {
            get { return _kprop2; }
            set { _kprop2 = value; }
        }

        public static bool KPropBool
        {
            get { return _kprop3; }
            set { _kprop3 = value; }
        }

        public static DateTime KPropDate
        {
            get { return _kprop4; }
            set { _kprop4 = value; }
        }

        public static TimeSpan KPropTime
        {
            get { return _kprop5; }
            set { _kprop5 = value; }
        }

        public static KlassNested1 KPropObject
        {
            get { return _kprop6; }
            set { _kprop6 = value; }
        }
        ...
        // Methods
        public static double KMethodRetNumber(double a, string b, bool c, DateTime d, TimeSpan e)
        {
            return a;
        }

        public static string KMethodRetString(double a, string b, bool c, DateTime d, TimeSpan e)
        {
            return b;
        }

        public static bool KMethodRetBool(double a, string b, bool c, DateTime d, TimeSpan e)
        {
            return c;
        }

        public static DateTime KMethodRetDate(double a, string b, bool c, DateTime d, TimeSpan e)
        {
            return d;
        }

        public static TimeSpan KMethodRetTime(double a, string b, bool c, DateTime d, TimeSpan e)
        {
            return e;
        }
        // END STATIC 
