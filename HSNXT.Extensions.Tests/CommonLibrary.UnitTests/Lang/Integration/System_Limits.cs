...
namespace HSNXT.ComLib.Lang.Tests.Integration.System
{
    ...
    {
        private void Run(List<string> scripts, Action<Interpreter, LangSettings> initializer = null,
            Action<Interpreter> assertCallback = null, bool isValid = false)
        {
        ...
        public void Can_Set_Loop_Limit_With_Try_Catch()
        {
            Run(
                new List<string>()
                {
                    "var result = 0; try{ for(var ndx = result; ndx < 20; ndx++) { result = ndx; } } catch(err){ } "
                },
                (i, settings) => settings.MaxLoopLimit = 10,
                i => CompareExpected(10, i.Memory.Get<object>("result")));
        }
        ...
        public void Can_Set_Recursion_Limit()
        {
            Run(
                new List<string>()
                {
                    "function Additive(n) { if (n == 0 )  return 0; return n + Additive(n-1); } var result = Additive(6);"
                },
        ...
        public void Can_Set_Call_Stack_Cyclic_Limit()
        {
            Run(
                new List<string>()
                {
                    "function Add1(n) { var l = n + 1; return Add2(l); } function Add2(n){ var l = n + 2; Add1(l); } var result = Add1(1); "
                },
            ...
            Run(
                new List<string>()
                {
                    "function Add1(n) { var l = n + 1; return Add2(l); } function Add2(n){ if(n > 5 ) return n; var l = n + 2; Add1(l); } var result = Add1(1); "
                },
        ...
        public void Can_Set_Recursion_LimitLess()
        {
            Run(
                new List<string>()
                {
                    "function Additive(n) { if (n == 0 )  return 0; return n + Additive(n-1); } var result = Additive(15);"
                },
                null,
        ...
        {
            var text =
                "var isActive = true; if(isActive){ while(isActive){ if(isActive) { try{ if(isActive) { isActive = false; } }catch(ex){ } } } } }";
        ...
        public void Can_Set_Exception_Limit()
        {
            Run(
                new List<string>()
                {
                    "var a = 0; try { throw 'error'; } catch(err) { a = 1; } try { throw 'error2'; } catch(er2) { a = 2; }"
                },
            ...
            Run(
                ...
                (i, settings) => settings.MaxExceptions = 1,
                (i) => CompareExpected(1, i.Context.Memory.Get<object>("a")));
        }
        ...
        public void Can_Set_Scope_Variables_String_Length_Total_Limit()
        {
            Run(
                new List<string>()
                {
                    "var a = '1234567890'; var b = '12345'; var c = 3; var d = '1234567890123456'; var e = 5;"
                },
