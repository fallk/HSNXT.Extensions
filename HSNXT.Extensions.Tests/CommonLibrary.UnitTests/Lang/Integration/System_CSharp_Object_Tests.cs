    ...
    public class Script_Tests_CSharp_Objects : ScriptTestsBase
    {
        ...
        public void Can_Create_Via_Different_Constructors()
        {
            var testcases = new List<Tuple<string, Type, object, string>>()
            {
                ...
                TestCase("result", typeof(string), "kish",
                    "var p = new Person('ki', 'sh'); var result = p.FirstName + p.LastName; "),
                TestCase("result", typeof(string), "nonew@email.com",
                    "var p = new Person('john', 'doe', 'nonew@email.com', true, 10.56); var result = p.Email;  "),
                TestCase("result", typeof(string), "janedallparams@email.comfalse",
                    "var p = new Person('jane', 'd', 'allparams@email.com', false, 10.56, new Date()); var result = p.FirstName + p.LastName + p.Email + p.IsMale;")
            };
        ...
        public void Can_Call_Static_Methods()
        {
            ...
            {
                TestCase("result", typeof(string), "test_1",
                    "var result = Klass2.KMethodRetString(12.34, 'test_1', true, new Date(2012, 10, 24), new Time(0, 7, 40, 20));"),
                TestCase("result", typeof(bool), true,
                    "var result = Klass2.KMethodRetBool(  12.34, 'test_1', true, new Date(2012, 10, 24), new Time(0, 7, 40, 20));"),
                TestCase("result", typeof(DateTime), date,
                    "var result = Klass2.KMethodRetDate(  12.34, 'test_1', true, new Date(2012, 10, 24), new Time(0, 7, 40, 20));"),
                TestCase("result", typeof(TimeSpan), time,
                    "var result = Klass2.KMethodRetTime(  12.34, 'test_1', true, new Date(2012, 10, 24), new Time(0, 7, 40, 20));"),
            };
        ...
        public void Can_Set_Instance_Properties()
        {
            var testcases = new List<Tuple<string, Type, object, string>>()
            {
                TestCase("result", typeof(string), "jane",
                    "var p = new Person();  p.FirstName = 'jane';      var result = p.FirstName;"),
                TestCase("result", typeof(string), "janedoe@email.com",
                    "var p = new Person();  p.Email     = 'janedoe@email.com'; var result = p.Email;"),
                TestCase("result", typeof(bool), false,
                    "var p = new Person();  p.IsMale    =  false;       var result = p.IsMale;"),
                TestCase("result", typeof(DateTime), DateTime.Today,
                    "var p = new Person();  p.BirthDate = new Date();   var result = p.BirthDate;"),
                TestCase("result", typeof(string), "Bronx",
                    "var p = new Person();  p.Address.City = 'Bronx';   var result = p.Address.City;"),
                TestCase("result", typeof(string), "NJ",
                    "var p = new Person();  p.Address.State = 'NJ';     var result = p.Address.State;")
            };
            Parse(testcases, true, (i) => i.Context.Types.Register(typeof(Person), null));
        }
        ...
        public void Can_Call_Instance_Methods()
        {
            var statements = new List<Tuple<string, Type, object, string>>()
            {
                TestCase("result", typeof(string), "ki sh",
                    "var p = new Person('ki', 'sh', 'comlib@email.com', true, 12.34); var result = p.FullName();"),
                TestCase("result", typeof(string), "programmer ki sh sr.",
                    "var p = new Person('ki', 'sh', 'comlib@email.com', true, 12.34); var result = p.FullNameWithPrefix('programmer', true);")
            };
        ...
        public void Can_Call_Instance_Methods_With_Named_Params()
        {
            ...
            {
                TestCase("result", typeof(string), "ki sh",
                    "var p = new Person(); p.Init( first: 'ki', last: 'sh', email: 'comlib@email.com', isMale: true, salary: 12.34, birthday: new Date(2012, 7, 10)); var result = p.FullName();"),
                TestCase("result", typeof(string), "ki sh",
                    "var p = new Person(); p.Init( 'ki', last: 'sh', email: 'comlib@email.com', isMale: true, salary: 12.34, birthday: new Date(2012, 7, 10)); var result = p.FullName();"),
                TestCase("result", typeof(string), "ki sh",
                    "var p = new Person(); p.Init( 'ki', 'sh', email: 'comlib@email.com', isMale: true, salary: 12.34, birthday: new Date(2012, 7, 10)); var result = p.FullName();"),
                TestCase("result", typeof(string), "ki sh",
                    "var p = new Person(); p.Init( 'ki', 'sh', 'comlib@email.com', isMale: true, salary: 12.34, birthday: new Date(2012, 7, 10)); var result = p.FullName();"),
                TestCase("result", typeof(string), "ki sh",
                    "var p = new Person(); p.Init( 'ki', 'sh', 'comlib@email.com', true, salary: 12.34, birthday: new Date(2012, 7, 10)); var result = p.FullName();"),
                TestCase("result", typeof(string), "ki sh",
                    "var p = new Person(); p.Init( 'ki', 'sh', 'comlib@email.com', true, 12.34, birthday: new Date(2012, 7, 10)); var result = p.FullName();"),
            };
            Parse(statements, true, (i) => i.Context.Types.Register(typeof(Person), null));
        }
        ...
        public void Can_Call_Instance_Methods_With_Named_Params_Using_Nulls()
        {
            ...
            {
                TestCase("result", typeof(string), "ki sh",
                    "var p = new Person(); p.Init( first: 'ki', last: 'sh', email: null, isMale: true, salary: 12.34, birthday: new Date(2012, 7, 10)); var result = p.FullName();"),
                TestCase("result", typeof(string), "ki sh",
                    "var p = new Person(); p.Init( 'ki', last: 'sh', email: 'comlib@email.com', isMale: null, salary: 12.34, birthday: new Date(2012, 7, 10)); var result = p.FullName();"),
                TestCase("result", typeof(string), "ki sh",
                    "var p = new Person(); p.Init( 'ki', 'sh', email: 'comlib@email.com', isMale: true, salary: null, birthday: null); var result = p.FullName();"),
            };
            Parse(statements, true, (i) => i.Context.Types.Register(typeof(Person), null));
        }
    }
