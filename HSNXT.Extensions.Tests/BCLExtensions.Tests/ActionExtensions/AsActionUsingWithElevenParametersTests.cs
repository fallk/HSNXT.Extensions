...
namespace BCLExtensions.Tests.ActionExtensions
{
    public class AsActionUsingWithElevenParametersTests
    {
        ...
        public void InternalActionExecutes()
        {
            ...
            Action<int, string, bool, decimal, byte, int, string, bool, decimal, byte, int?> action =
                (p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11) => { internalActionWasCalled = true; };
        ...
        public void InternalActionCapturesCorrectParameters()
        {
            ...
            var result = action.AsActionUsing(expectedParameter1, expectedParameter2, expectedParameter3,
                ...
                expectedParameter9, expectedParameter10, expectedParameter11);
            result();
