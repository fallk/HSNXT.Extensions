...
namespace HSNXT.PGK.Extensions.Tests
{
    ...
    public class StringExtensionsTest
    {
        ...
        public void ToGuid()
        {
            ...
            var baExpected = new byte[]
                {0x78, 0x56, 0x34, 0x12, 0x12, 0x9a, 0x56, 0x34, 0x78, 0x9b, 0x12, 0x34, 0x56, 0x78, 0x9c, 0x12};
        ...
        public void ToTitleCase_MixedCase()
        {
            ...
            var expectedResult =
                "This IS A Test"; // UppperCase characters is the source string after the first of each word are lowered, unless the word is exactly 2 character.
        ...
        public void TestExtractArguments()
        {
            ...
            args = str.ExtractArguments(@"My name is {1} {0}. I'm from {2}.",
                HSNXT.Extensions.ComparsionTemplateOptions.Whole);
            Assert.AreEqual(args.Count(), 3);
            Assert.AreEqual(args.ElementAt(0), "Nagovitsyn");
            Assert.AreEqual(args.ElementAt(1), "Aleksey");
            Assert.AreEqual(args.ElementAt(2), "Russia");
            ...
            args = str.ExtractArguments(@"I'm FROM {0}.", HSNXT.Extensions.ComparsionTemplateOptions.Default,
