...
namespace HSNXT.PGK.Extensions.Test4
{
    ...
    public class StringExtensionsTest
    {
        ...
        public void ToPluralTest()
        {
            ...
            Assert.AreEqual("phenomenon".ToPlural2(),
                "phenomena"); // nouns that maintain their Latin or Greek form in the plural
        ...
        public void ExtractPerformanceTest()
        {
            ...
            sw.Stop();
            Console.WriteLine("Extract(CharTypes.LettersOrDigits | CharTypes.WhiteSpace): {0} msecs",
