...
namespace HSNXT.Test
{
    ...
    class FromTest
    {
        ...
        public void TestFromIsLazy()
        {
            ...
            Extensions.From(breakingFunc);
            Extensions.From(breakingFunc, breakingFunc);
            Extensions.From(breakingFunc, breakingFunc, breakingFunc);
            Extensions.From(breakingFunc, breakingFunc, breakingFunc, breakingFunc);
        }
