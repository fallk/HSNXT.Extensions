namespace CodeBetter.Extensions.Tests
{
   ...
   public class StringConversionTests
   {
      ...
      {
         Assert.AreEqual("he said &quot;life is like a box of &lt;i&gt;jello!&lt;/i&gt;", "he said \"life is like a box of <i>jello!</i>".EncodeHtml());
      }
      [Test]
      public void DecodeHtml()
      {
         Assert.AreEqual("he said \"life is like a box of <i>jello!</i>", "he said &quot;life is like a box of &lt;i&gt;jello!&lt;/i&gt;".DecodeHtml());
      }
      [Test]
      ...
      public void EncodeBase64_WithEncoding()
      {
         ...
         Assert.AreEqual("aQB0ACcAcwAgAG8AdgBlAHIAIAA5ADAAMAAwAA==", "it's over 9000".EncodeBase64(EncodingType.Unicode));
      }
      [Test]
      ...
      public void DecodeBase64_WithEncoding()
      {
         ...
         Assert.AreEqual("it's over 9000", "aQB0ACcAcwAgAG8AdgBlAHIAIAA5ADAAMAAwAA==".DecodeBase64(EncodingType.Unicode));
      }
      [Test]
